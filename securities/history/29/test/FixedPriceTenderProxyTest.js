...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(65,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,contractMath.address,97,1338,{from:accounts[3]});
});
