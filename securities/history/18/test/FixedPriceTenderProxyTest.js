...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(256,contractRedeemableToken.address,contractRedeemableToken.address,accounts[7],2014223716,2014223715,{from:accounts[0]});
});
