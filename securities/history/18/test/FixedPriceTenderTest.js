...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223716,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[5],64,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+735,{from:accounts[5]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+2,{from: accounts[5]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223716,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[5],64,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+735,{from:accounts[5]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+2,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223716,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[0],6,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+325,{from:accounts[5]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(5,{from: accounts[5]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223716,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[0],6,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+325,{from:accounts[5]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(5,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(256,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[6],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+61,{from:accounts[5]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(96,{from: accounts[5]});
  });
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(256,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[6],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+61,{from:accounts[5]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(96,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(257,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[6],96,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+222,{from:accounts[5]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[5]});
    let result = await localFixedPriceTender.optInToTender(1532892063,{from: accounts[5]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(257,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[6],96,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+222,{from:accounts[5]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(1532892063,{from: accounts[5]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223716,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[2],1337,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+866,{from:accounts[5]});
