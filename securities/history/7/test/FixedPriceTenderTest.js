...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(4,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[3],96,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+993,{from:accounts[4]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+301,{from: accounts[4]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(4,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[3],96,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+993,{from:accounts[4]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+301,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(29,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[7],4,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+267,{from:accounts[4]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(4,{from: accounts[4]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(29,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[7],4,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+267,{from:accounts[4]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(4,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(29,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[8],10001,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+698,{from:accounts[4]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(2014223716,{from: accounts[4]});
  });
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(29,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[8],10001,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+698,{from:accounts[4]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(2014223716,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(4,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[4],5,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+468,{from:accounts[4]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[4]});
    let result = await localFixedPriceTender.optInToTender(5,{from: accounts[4]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(4,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[4],5,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+468,{from:accounts[4]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(5,{from: accounts[4]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892063,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[7],66,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+994,{from:accounts[4]});
    let result = await localFixedPriceTender.optOutOfTender(9999,{from: accounts[4]});
  });
