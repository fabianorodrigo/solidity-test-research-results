...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1338,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[1],1337,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+451,{from:accounts[1]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+128,{from: accounts[1]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1338,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[1],1337,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+451,{from:accounts[1]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+128,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(10000,contractRedeemableToken.address,contractRedeemableToken.address,accounts[9],64,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+558,{from:accounts[1]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(256,{from: accounts[1]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(10000,contractRedeemableToken.address,contractRedeemableToken.address,accounts[9],64,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+558,{from:accounts[1]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(256,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(6,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[9],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+697,{from:accounts[1]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(26,{from: accounts[1]});
  });
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(6,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[9],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+697,{from:accounts[1]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(26,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892064,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[7],2,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+444,{from:accounts[1]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[1]});
    let result = await localFixedPriceTender.optInToTender(1,{from: accounts[1]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892064,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[7],2,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+444,{from:accounts[1]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(1,{from: accounts[1]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(255,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[9],27,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+212,{from:accounts[1]});
    let result = await localFixedPriceTender.optOutOfTender(66,{from: accounts[1]});
  });
  ...
  it('Should execute finaliseTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp>=offerEndTime,nextTenderToAssess<orderedHolders.length,_batchSize>0', async () => {
    let result = await contractFixedPriceTender.finaliseTender(5,{from: accounts[0]});
  });
