...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(26,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[6],6,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+990,{from:accounts[7]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+164,{from: accounts[7]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(26,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[6],6,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+990,{from:accounts[7]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+164,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(28,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[4],2,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+399,{from:accounts[7]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(2014223715,{from: accounts[7]});
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892064,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[2],1337,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+400,{from:accounts[7]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(10001,{from: accounts[7]});
  });
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892064,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[2],1337,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+400,{from:accounts[7]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(10001,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(256,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[8],0,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+235,{from:accounts[7]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[7]});
    let result = await localFixedPriceTender.optInToTender(1337,{from: accounts[7]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(256,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[8],0,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+235,{from:accounts[7]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(1337,{from: accounts[7]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(3,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[8],2014223715,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+170,{from:accounts[7]});
    let result = await localFixedPriceTender.optOutOfTender(9999,{from: accounts[7]});
  });
