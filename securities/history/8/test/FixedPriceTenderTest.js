...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223715,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[4],1338,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+722,{from:accounts[9]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+133,{from: accounts[9]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223715,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[4],1338,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+722,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+133,{from: accounts[8]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[7],66,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+542,{from:accounts[9]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(254,{from: accounts[9]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[7],66,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+542,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(254,{from: accounts[8]}),'revert');
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892064,contractRedeemableToken.address,contractRedeemableToken.address,accounts[5],28,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+523,{from:accounts[9]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(1532892063,{from: accounts[9]});
  });
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892064,contractRedeemableToken.address,contractRedeemableToken.address,accounts[5],28,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+523,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(1532892063,{from: accounts[8]}),'revert');
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223714,contractRedeemableToken.address,contractRedeemableToken.address,accounts[3],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+34,{from:accounts[9]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[9]});
    let result = await localFixedPriceTender.optInToTender(10001,{from: accounts[9]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223714,contractRedeemableToken.address,contractRedeemableToken.address,accounts[3],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+34,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(10001,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(256,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[5],65,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+599,{from:accounts[9]});
    let result = await localFixedPriceTender.optOutOfTender(66,{from: accounts[9]});
  });
