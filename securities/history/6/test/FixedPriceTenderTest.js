...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(27,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[2],5,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+868,{from:accounts[7]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+500,{from: accounts[7]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(27,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[2],5,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+868,{from:accounts[7]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+500,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(3,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[3],5,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+369,{from:accounts[7]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(1532892063,{from: accounts[7]});
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(28,contractRedeemableToken.address,contractRedeemableToken.address,accounts[0],97,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+431,{from:accounts[7]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(64,{from: accounts[7]});
  });
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(28,contractRedeemableToken.address,contractRedeemableToken.address,accounts[0],97,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+431,{from:accounts[7]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(64,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[4],10000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+611,{from:accounts[7]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[7]});
    let result = await localFixedPriceTender.optInToTender(5,{from: accounts[7]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[4],10000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+611,{from:accounts[7]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(5,{from: accounts[7]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(97,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[6],255,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+958,{from:accounts[7]});
    let result = await localFixedPriceTender.optOutOfTender(1,{from: accounts[7]});
  });
  ...
  it('Should execute finaliseTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp>=offerEndTime,nextTenderToAssess<orderedHolders.length,_batchSize>0', async () => {
    let result = await contractFixedPriceTender.finaliseTender(2014223715,{from: accounts[0]});
  });
