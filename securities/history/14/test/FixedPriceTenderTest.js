...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(254,contractRedeemableToken.address,contractRedeemableToken.address,accounts[6],1532892063,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+355,{from:accounts[1]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+788,{from: accounts[1]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(254,contractRedeemableToken.address,contractRedeemableToken.address,accounts[6],1532892063,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+355,{from:accounts[1]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+788,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(97,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[3],254,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+758,{from:accounts[1]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(66,{from: accounts[1]});
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223714,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[2],257,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+143,{from:accounts[1]});
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(28,contractRedeemableToken.address,contractRedeemableToken.address,accounts[6],257,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+159,{from:accounts[1]});
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(65,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[6],1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+465,{from:accounts[1]});
    let result = await localFixedPriceTender.optOutOfTender(97,{from: accounts[1]});
  });
