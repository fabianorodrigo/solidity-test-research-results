...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223714,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[0],2014223714,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+943,{from:accounts[1]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+608,{from: accounts[1]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223714,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[0],2014223714,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+943,{from:accounts[1]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+608,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(10001,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[0],1532892064,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+549,{from:accounts[1]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(1,{from: accounts[1]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(10001,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[0],1532892064,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+549,{from:accounts[1]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(1,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(255,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[0],256,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+378,{from:accounts[1]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(1532892062,{from: accounts[1]});
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1338,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[6],10000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+355,{from:accounts[1]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[1]});
    let result = await localFixedPriceTender.optInToTender(2014223714,{from: accounts[1]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1338,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[6],10000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+355,{from:accounts[1]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(2014223714,{from: accounts[1]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(95,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[5],96,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+223,{from:accounts[1]});
    let result = await localFixedPriceTender.optOutOfTender(1532892062,{from: accounts[1]});
  });
  ...
  it('Should execute finaliseTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp>=offerEndTime,nextTenderToAssess<orderedHolders.length,_batchSize>0', async () => {
    let result = await contractFixedPriceTender.finaliseTender(65,{from: accounts[0]});
  });
