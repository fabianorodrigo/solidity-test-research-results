...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(1338,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[9],255,97,{from:accounts[1]});
});
