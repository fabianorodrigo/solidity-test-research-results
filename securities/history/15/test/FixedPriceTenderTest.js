...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[2],28,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+259,{from:accounts[5]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+354,{from: accounts[5]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[2],28,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+259,{from:accounts[5]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+354,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(257,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[3],1338,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+477,{from:accounts[5]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(97,{from: accounts[5]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(257,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[3],1338,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+477,{from:accounts[5]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(97,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(26,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[1],257,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+801,{from:accounts[5]});
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892063,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[2],5,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+587,{from:accounts[5]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[5]});
    let result = await localFixedPriceTender.optInToTender(96,{from: accounts[5]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892063,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[2],5,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+587,{from:accounts[5]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(96,{from: accounts[5]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892064,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[9],64,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+679,{from:accounts[5]});
    let result = await localFixedPriceTender.optOutOfTender(64,{from: accounts[5]});
  });
  ...
  it('Should execute finaliseTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp>=offerEndTime,nextTenderToAssess<orderedHolders.length,_batchSize>0', async () => {
    let result = await contractFixedPriceTender.finaliseTender(257,{from: accounts[0]});
  });
