...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(29,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[0],65,1338,{from:accounts[5]});
});
