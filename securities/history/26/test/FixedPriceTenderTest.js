...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[9],96,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+804,{from:accounts[0]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+973,{from: accounts[0]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[9],96,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+804,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+973,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(27,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[0],9999,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+577,{from:accounts[0]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(2014223716,{from: accounts[0]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(27,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[0],9999,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+577,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(2014223716,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(3,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[9],257,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+247,{from:accounts[0]});
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(29,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[5],1532892062,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+166,{from:accounts[0]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[0]});
    let result = await localFixedPriceTender.optInToTender(6,{from: accounts[0]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(29,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[5],1532892062,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+166,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(6,{from: accounts[0]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223714,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[1],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+628,{from:accounts[0]});
    let result = await localFixedPriceTender.optOutOfTender(10001,{from: accounts[0]});
  });
