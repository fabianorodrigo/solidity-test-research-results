...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(9999,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[5],27,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+307,{from:accounts[8]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+527,{from: accounts[8]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(9999,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[5],27,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+307,{from:accounts[8]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+527,{from: accounts[9]}),'revert');
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: _newOfferEnd >= (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(9999,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[5],27,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+307,{from:accounts[8]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp-1,{from: accounts[8]}),'revert');
  });
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1337,contractRedeemableToken.address,contractRedeemableToken.address,accounts[7],255,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+912,{from:accounts[8]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(1532892062,{from: accounts[8]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1337,contractRedeemableToken.address,contractRedeemableToken.address,accounts[7],255,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+912,{from:accounts[8]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(1532892062,{from: accounts[9]}),'revert');
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: _newPaymentPerSecurity > 0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1337,contractRedeemableToken.address,contractRedeemableToken.address,accounts[7],255,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+912,{from:accounts[8]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(0,{from: accounts[8]}),'revert');
  });
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(26,contractRedeemableToken.address,contractRedeemableToken.address,accounts[8],2014223715,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+751,{from:accounts[8]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(95,{from: accounts[8]});
  });
  ...
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: _newTotalToRepurchase >= 0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(26,contractRedeemableToken.address,contractRedeemableToken.address,accounts[8],2014223715,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+751,{from:accounts[8]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(-1,{from: accounts[8]}),'revert');
  });
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(256,contractRedeemableToken.address,contractRedeemableToken.address,accounts[5],255,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+912,{from:accounts[8]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[8]});
    let result = await localFixedPriceTender.optInToTender(28,{from: accounts[8]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(256,contractRedeemableToken.address,contractRedeemableToken.address,accounts[5],255,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+912,{from:accounts[8]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(28,{from: accounts[8]}),'revert');
  });
  it('Should fail optInToTender(uint256) when NOT comply with: _numberToTender > 0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(256,contractRedeemableToken.address,contractRedeemableToken.address,accounts[5],255,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+912,{from:accounts[8]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[8]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(0,{from: accounts[8]}),'revert');
  });
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractRedeemableToken.address,contractRedeemableToken.address,accounts[1],1,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+750,{from:accounts[8]});
    let result = await localFixedPriceTender.optOutOfTender(256,{from: accounts[8]});
  });
  it('Should fail optOutOfTender(uint256) when NOT comply with: _numberToRemove > 0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractRedeemableToken.address,contractRedeemableToken.address,accounts[1],1,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+750,{from:accounts[8]});
    let result = await truffleAssert.fails(localFixedPriceTender.optOutOfTender(0,{from: accounts[8]}),'revert');
  });
  it('Should execute finaliseTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp>=offerEndTime,nextTenderToAssess<orderedHolders.length,_batchSize>0', async () => {
    let result = await contractFixedPriceTender.finaliseTender(256,{from: accounts[0]});
  });
