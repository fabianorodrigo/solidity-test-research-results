...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[8],4,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+585,{from:accounts[7]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+414,{from: accounts[7]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[8],4,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+585,{from:accounts[7]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+414,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(28,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[2],97,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+239,{from:accounts[7]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(255,{from: accounts[7]});
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(65,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[0],2014223715,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+876,{from:accounts[7]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(9999,{from: accounts[7]});
  });
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(65,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[0],2014223715,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+876,{from:accounts[7]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(9999,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[4],27,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+729,{from:accounts[7]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[7]});
    let result = await localFixedPriceTender.optInToTender(64,{from: accounts[7]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[4],27,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+729,{from:accounts[7]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(64,{from: accounts[7]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[1],28,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+59,{from:accounts[7]});
    let result = await localFixedPriceTender.optOutOfTender(6,{from: accounts[7]});
  });
