...
contract("contractProxyBaseSwaps",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractBaseSwaps = await BaseSwaps.new(accounts[8],accounts[4],accounts[5],29,1532892064,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+760,{from:accounts[0]});
    if(trace) console.log('SUCESSO: BaseSwaps.new(accounts[8],accounts[4],accounts[5],29,1532892064,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+760,{from:accounts[0]}');
      ProxyBaseSwaps.link("SafeMath",contractSafeMath.address);
    contractProxyBaseSwaps = await ProxyBaseSwaps.new(accounts[8],accounts[4],accounts[5],29,1532892064,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+760,{from:accounts[0]});
});
  ...
  it('Should fail test_refund(address) when NOT comply with: isSwapped != true', async () => {
    let localcontractProxyBaseSwaps = await ProxyBaseSwaps.new(accounts[9],"0x0000000000000000000000000000000000000000",accounts[6],254,1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+583,{from:accounts[0]});
  ...
  it('Should fail test_swap() when NOT comply with: isSwapped != true', async () => {
    let localcontractProxyBaseSwaps = await ProxyBaseSwaps.new(accounts[5],"0x0000000000000000000000000000000000000000",accounts[0],1532892064,6,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+796,{from:accounts[0]});
    await localcontractProxyBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should execute test_distribute(address,address)', async () => {
    let result = await contractProxyBaseSwaps.test_distribute(accounts[8], accounts[8],{from: accounts[0]});
  });
  it('Should execute test_sendTokens(address,address,uint) WHEN _token==0x0000000000000000000000000000000000000000', async () => {
    let result = await contractProxyBaseSwaps.test_sendTokens("0x0000000000000000000000000000000000000000", accounts[6], 96,{from: accounts[0]});
  });
  it('Should execute test_sendTokens(address,address,uint) WHEN _token!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractProxyBaseSwaps.test_sendTokens(accounts[7], accounts[3], 9999,{from: accounts[0]});
  });
  it('Should execute test_removeInvestor(address[],address)', async () => {
    let result = await contractProxyBaseSwaps.test_removeInvestor([accounts[6],accounts[5],accounts[6],accounts[8],accounts[1],accounts[1],accounts[3]], accounts[7],{from: accounts[0]});
  });
  ...
  it('Should execute test_depositTokens(address,uint) WHEN quoteAddress==_token,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractProxyBaseSwaps.test_depositTokens(accounts[6], 257,{from: accounts[0]});
  });
  it('Should execute test_deposit(address,address,uint) WHEN FunctionCall!=true,quoteAddress==_token,raised<limits,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractProxyBaseSwaps.test_deposit(accounts[5], accounts[1], 29,{from: accounts[0]});
  });
  it('Should execute test_deposit(address,address,uint) WHEN FunctionCall==true,baseAddress==_token,raised<limits,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractProxyBaseSwaps.test_deposit(accounts[9], accounts[8], 2,{from: accounts[0]});
  });
  it('Should execute test_isInvestor(address,address)', async () => {
    let result = await contractProxyBaseSwaps.test_isInvestor(accounts[9], accounts[7],{from: accounts[0]});
  });
});
