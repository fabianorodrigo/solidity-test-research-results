...
contract("BaseSwaps",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractBaseSwaps = await BaseSwaps.new(accounts[8],accounts[5],accounts[7],4,29,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+702,{from:accounts[0]});
    if(trace) console.log('SUCESSO: BaseSwaps.new(accounts[8],accounts[5],accounts[7],4,29,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+702,{from:accounts[0]}');
  });
  ...
  it('Should execute fallback() WHEN quoteAddress==0x0000000000000000000000000000000000000000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[1],accounts[7],"0x0000000000000000000000000000000000000000",2,10000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+15,{from:accounts[0]});
  ...
  it('Should fail fallback() when NOT comply with: quoteAddress == 0x0000000000000000000000000000000000000000', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[1],accounts[8],accounts[1],2,97,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+746,{from:accounts[0]});
  ...
  it('Should execute depositBaseTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositBaseTokens(10000,{from: accounts[0]});
  });
  it('Should execute depositQuoteTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositQuoteTokens(0,{from: accounts[0]});
  });
  ...
  it('Should fail cancel() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[5],accounts[3],"0x0000000000000000000000000000000000000000",11,1337,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+23,{from:accounts[0]});
  ...
  it('Should fail refundBase() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[6],"0x0000000000000000000000000000000000000000",accounts[8],2,1532892064,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+582,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should fail refundQuote() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[7],accounts[9],"0x0000000000000000000000000000000000000000",5,4038714811,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+799,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should execute baseUserInvestment(address)', async () => {
    let result = await contractBaseSwaps.baseUserInvestment(accounts[6],{from: accounts[0]});
  });
  it('Should execute quoteUserInvestment(address)', async () => {
    let result = await contractBaseSwaps.quoteUserInvestment(accounts[1],{from: accounts[0]});
  });
