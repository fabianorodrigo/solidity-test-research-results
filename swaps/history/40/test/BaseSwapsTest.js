...
contract("BaseSwaps",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractBaseSwaps = await BaseSwaps.new(accounts[9],accounts[6],accounts[8],1338,29,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+214,{from:accounts[0]});
    if(trace) console.log('SUCESSO: BaseSwaps.new(accounts[9],accounts[6],accounts[8],1338,29,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+214,{from:accounts[0]}');
  });
  ...
  it('Should execute fallback() WHEN baseAddress==0x0000000000000000000000000000000000000000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[8],"0x0000000000000000000000000000000000000000",accounts[4],97,256,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+610,{from:accounts[0]});
  ...
  it('Should fail fallback() when NOT comply with: baseAddress == 0x0000000000000000000000000000000000000000', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[2],accounts[7],accounts[8],26,255,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+851,{from:accounts[0]});
  ...
  it('Should execute depositQuoteTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositQuoteTokens(1337,{from: accounts[0]});
  });
  ...
  it('Should fail cancel() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[6],"0x0000000000000000000000000000000000000000",accounts[5],1532892063,257,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+189,{from:accounts[0]});
  ...
  it('Should fail refundBase() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[8],"0x0000000000000000000000000000000000000000",accounts[4],1532892063,10,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+905,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should fail refundQuote() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[7],accounts[5],"0x0000000000000000000000000000000000000000",66,10001,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+676,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
