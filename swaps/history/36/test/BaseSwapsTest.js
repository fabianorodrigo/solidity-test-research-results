...
contract("BaseSwaps",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractBaseSwaps = await BaseSwaps.new(accounts[7],accounts[3],accounts[5],255,4038714810,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+548,{from:accounts[0]});
    if(trace) console.log('SUCESSO: BaseSwaps.new(accounts[7],accounts[3],accounts[5],255,4038714810,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+548,{from:accounts[0]}');
  });
  ...
  it('Should execute fallback() WHEN baseAddress==0x0000000000000000000000000000000000000000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[4],"0x0000000000000000000000000000000000000000",accounts[2],256,97,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+998,{from:accounts[0]});
  ...
  it('Should fail fallback() when NOT comply with: baseAddress == 0x0000000000000000000000000000000000000000', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[1],accounts[5],accounts[1],2014223715,254,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+195,{from:accounts[0]});
  ...
  it('Should fail cancel() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[5],"0x0000000000000000000000000000000000000000",accounts[7],1336,64,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+837,{from:accounts[0]});
  ...
  it('Should fail refundBase() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[3],"0x0000000000000000000000000000000000000000",accounts[2],5,254,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+505,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should fail refundQuote() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[9],accounts[1],"0x0000000000000000000000000000000000000000",9,10001,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+748,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
