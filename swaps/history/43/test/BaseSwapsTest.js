...
contract("BaseSwaps",(accounts)=>{
  ...
  it('Should execute fallback() WHEN quoteAddress==0x0000000000000000000000000000000000000000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[3],accounts[9],"0x0000000000000000000000000000000000000000",2014223714,97,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+869,{from:accounts[0]});
  ...
  it('Should fail fallback() when NOT comply with: quoteAddress == 0x0000000000000000000000000000000000000000', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[3],accounts[8],accounts[6],1336,4038714809,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+346,{from:accounts[0]});
  ...
  it('Should execute depositQuoteTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositQuoteTokens(6,{from: accounts[0]});
  });
  ...
  it('Should fail cancel() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[4],"0x0000000000000000000000000000000000000000",accounts[1],29,28,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+110,{from:accounts[0]});
  ...
  it('Should fail refundBase() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[7],"0x0000000000000000000000000000000000000000",accounts[5],2,255,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+508,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should fail refundQuote() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[1],"0x0000000000000000000000000000000000000000",accounts[0],2,3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+104,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should execute baseUserInvestment(address)', async () => {
    let result = await contractBaseSwaps.baseUserInvestment(accounts[7],{from: accounts[0]});
  });
