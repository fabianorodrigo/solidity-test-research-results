...
contract("HarbergerAds",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractHarbergerAds = await HarbergerAds.new(contractERC20test.address,65,1331007098,{from:accounts[0]});
    if(trace) console.log('SUCESSO: HarbergerAds.new(contractERC20test.address,65,1331007098,{from:accounts[0]}');
  });
  
  it('Should execute taxesDue(uint256) WHEN 1>0', async () => {
    let result = await contractHarbergerAds.taxesDue(96,{from: accounts[0]});
  });
  ...
  it('Should execute buy(uint256,uint256,uint256) WHEN seller!=msg.sender', async () => {
    let result = await contractHarbergerAds.buy(97, 1331007098, 26,{from: accounts[6]});
  });
  it('Should execute buy(uint256,uint256,uint256) WHEN seller==msg.sender', async () => {
    let result = await contractHarbergerAds.buy(1331007096, 65, 1532892062,{from: accounts[0]});
  });
  ...
  it('Should execute changeRecipient(uint256,address)', async () => {
    let result = await contractHarbergerAds.changeRecipient(65, accounts[9],{from: accounts[0]});
  });
});
