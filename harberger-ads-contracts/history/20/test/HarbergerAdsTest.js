...
contract("HarbergerAds",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractHarbergerAds = await HarbergerAds.new(contractERC20test.address,1331007098,64,{from:accounts[0]});
    if(trace) console.log('SUCESSO: HarbergerAds.new(contractERC20test.address,1331007098,64,{from:accounts[0]}');
  });
  
  it('Should execute taxesDue(uint256) WHEN 1>0', async () => {
    let result = await contractHarbergerAds.taxesDue(28,{from: accounts[0]});
  });
  ...
  it('Should execute addProperty(uint256)', async () => {
    let result = await contractHarbergerAds.addProperty(1331007098,{from: accounts[0]});
  });
  it('Should execute forecloseIfPossible(uint256)', async () => {
    let result = await contractHarbergerAds.forecloseIfPossible(28,{from: accounts[0]});
  });
  it('Should execute collectTaxes(uint256) WHEN taxes>0,taxes<=balance', async () => {
    let result = await contractHarbergerAds.collectTaxes(64,{from: accounts[0]});
  });
  it('Should execute collectTaxes(uint256) WHEN taxes<=0,taxes<=balance', async () => {
  ...
  it('Should execute collectTaxes(uint256) WHEN balance>0,taxes>balance', async () => {
    let result = await contractHarbergerAds.collectTaxes(0,{from: accounts[0]});
  });
  it('Should execute collectTaxes(uint256) WHEN balance<=0,taxes>balance', async () => {
  ...
  it('Should execute buy(uint256,uint256,uint256) WHEN seller!=msg.sender', async () => {
    let result = await contractHarbergerAds.buy(3, 1331007096, 1331007097,{from: accounts[7]});
  });
  it('Should execute buy(uint256,uint256,uint256) WHEN seller==msg.sender', async () => {
    let result = await contractHarbergerAds.buy(1532892062, 1, 2014223714,{from: accounts[3]});
  });
  ...
  it('Should execute changeRecipient(uint256,address)', async () => {
    let result = await contractHarbergerAds.changeRecipient(5, accounts[4],{from: accounts[0]});
  });
});
