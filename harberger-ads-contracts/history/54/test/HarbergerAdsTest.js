...
contract("HarbergerAds",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractHarbergerAds = await HarbergerAds.new(contractERC20test.address,18,2014223714,{from:accounts[0]});
    if(trace) console.log('SUCESSO: HarbergerAds.new(contractERC20test.address,18,2014223714,{from:accounts[0]}');
  });
  
  it('Should execute taxesDue(uint256) WHEN 1>0', async () => {
    let result = await contractHarbergerAds.taxesDue(66,{from: accounts[0]});
  });
  ...
  it('Should execute balanceOf(address) WHEN balance<=allowance', async () => {
    let result = await contractHarbergerAds.balanceOf(accounts[1],{from: accounts[0]});
  });
  ...
  it('Should execute forecloseIfPossible(uint256)', async () => {
    let result = await contractHarbergerAds.forecloseIfPossible(3,{from: accounts[0]});
  });
  it('Should execute collectTaxes(uint256) WHEN taxes>0,taxes<=balance', async () => {
    let result = await contractHarbergerAds.collectTaxes(17,{from: accounts[0]});
  });
  it('Should execute collectTaxes(uint256) WHEN taxes<=0,taxes<=balance', async () => {
  ...
  it('Should execute collectTaxes(uint256) WHEN balance<=0,taxes>balance', async () => {
    let result = await contractHarbergerAds.collectTaxes(27,{from: accounts[0]});
  });
  it('Should execute buy(uint256,uint256,uint256) WHEN seller!=msg.sender', async () => {
    let result = await contractHarbergerAds.buy(1532892064, 97, 1331007096,{from: accounts[0]});
  });
  it('Should execute buy(uint256,uint256,uint256) WHEN seller==msg.sender', async () => {
    let result = await contractHarbergerAds.buy(2014223715, 1532892063, 27,{from: accounts[5]});
  });
  ...
  it('Should execute changeRecipient(uint256,address)', async () => {
    let result = await contractHarbergerAds.changeRecipient(27, accounts[4],{from: accounts[0]});
  });
});
