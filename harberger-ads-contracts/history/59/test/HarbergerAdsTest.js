...
contract("HarbergerAds",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractHarbergerAds = await HarbergerAds.new(contractERC20test.address,4,1331007097,{from:accounts[0]});
    if(trace) console.log('SUCESSO: HarbergerAds.new(contractERC20test.address,4,1331007097,{from:accounts[0]}');
  });
  ...
  it('Should execute addProperty(uint256)', async () => {
    let result = await contractHarbergerAds.addProperty(17,{from: accounts[0]});
  });
  it('Should execute forecloseIfPossible(uint256)', async () => {
    let result = await contractHarbergerAds.forecloseIfPossible(19,{from: accounts[0]});
  });
  ...
  it('Should execute collectTaxes(uint256) WHEN balance>0,taxes>balance', async () => {
    let result = await contractHarbergerAds.collectTaxes(65,{from: accounts[0]});
  });
  it('Should execute collectTaxes(uint256) WHEN balance<=0,taxes>balance', async () => {
    let result = await contractHarbergerAds.collectTaxes(5,{from: accounts[0]});
  });
  it('Should execute buy(uint256,uint256,uint256) WHEN seller!=msg.sender', async () => {
    let result = await contractHarbergerAds.buy(65, 64, 97,{from: accounts[0]});
  });
  it('Should execute buy(uint256,uint256,uint256) WHEN seller==msg.sender', async () => {
    let result = await contractHarbergerAds.buy(65, 5, 1532892064,{from: accounts[7]});
  });
  ...
  it('Should execute changeRecipient(uint256,address)', async () => {
    let result = await contractHarbergerAds.changeRecipient(1532892062, accounts[0],{from: accounts[0]});
  });
});
