...
contract("NOIAToken",(accounts)=>{
  ...
  it('Should execute transfer(address,uint256) WHEN success==true', async () => {
    let result = await contractNOIAToken.methods["transfer(address,uint256)"](contractCanonicalBurner.address, 65,{from: accounts[0]});
  });
  it('Should execute transfer(address,uint256) WHEN success!=true', async () => {
    let result = await contractNOIAToken.methods["transfer(address,uint256)"](contractCanonicalBurner.address, 1338,{from: accounts[0]});
  });
  it('Should execute transferFrom(address,address,uint256) WHEN success==true', async () => {
    let result = await contractNOIAToken.methods["transferFrom(address,address,uint256)"](accounts[3], contractNOIAVault.address, 18,{from: accounts[0]});
  });
  it('Should execute transferFrom(address,address,uint256) WHEN success!=true', async () => {
    let result = await contractNOIAToken.methods["transferFrom(address,address,uint256)"](accounts[5], contractCanonicalBurner.address, 2014223716,{from: accounts[0]});
  });
  it('Should execute mint(address,uint256) WHEN msg.sender==_owner,to!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractNOIAToken.mint(accounts[0], 2014223715,{from: accounts[0]});
  });
  it('Should fail mint(address,uint256) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractNOIAToken.mint(accounts[0], 2014223715,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute burn(uint256) WHEN msg.sender==burnAddress,tokensToMint==0,msg.sender!=0x0000000000000000000000000000000000000000', async () => {
    ...
    await contractNOIAToken.mint(accounts[2],0,{from:accounts[0]});
    let result = await contractNOIAToken.burn(65,{from: accounts[0]});
  });
  it('Should fail burn(uint256) when NOT comply with: msg.sender == burnAddress', async () => {
    await contractNOIAToken.setBurnAddress(accounts[0],{from:accounts[0]});
    await contractNOIAToken.mint(accounts[2],0,{from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.burn(65,{from: accounts[9]}),'revert');
  });
  it('Should fail burn(uint256) when NOT comply with: tokensToMint == 0', async () => {
    await contractNOIAToken.setBurnAddress(accounts[0],{from:accounts[0]});
    await contractNOIAToken.mint(accounts[2],27,{from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.burn(65,{from: accounts[0]}),'revert');
  });
  it('Should fail burn(uint256) when NOT comply with: msg.sender != 0x0000000000000000000000000000000000000000', async () => {
    await contractNOIAToken.setBurnAddress(accounts[0],{from:accounts[0]});
    await contractNOIAToken.mint(accounts[2],0,{from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.burn(65,{from: 0}),'revert');
  });
  ...
  it('Should execute transferPreSigned(bytes,address,uint256,uint256,uint256) WHEN msg.sender==_to,etherlessTransferEnabled==true,_to!=0x0000000000000000000000000000000000000000,from!=0x0000000000000000000000000000000000000000,hashedTxs==false,_to!=0x0000000000000000000000000000000000000000', async () => {
    ...
    let result = await contractNOIAToken.transferPreSigned([77,118,123,174,196,207,199,89,97,232,142,171,99,170,165,215,57,204,55,23,169,7,20,128,0,198,147,133,185,60,186,130], accounts[0], 256, 6, 17,{from: accounts[0]});
  });
  it('Should fail transferPreSigned(bytes,address,uint256,uint256,uint256) when NOT comply with: etherlessTransferEnabled == true', async () => {
    ...
    let result = await truffleAssert.fails(contractNOIAToken.transferPreSigned([77,118,123,174,196,207,199,89,97,232,142,171,99,170,165,215,57,204,55,23,169,7,20,128,0,198,147,133,185,60,186,130], accounts[0], 256, 6, 17,{from: accounts[0]}),'revert');
  });
  it('Should fail transferPreSigned(bytes,address,uint256,uint256,uint256) when NOT comply with: _to != 0x0000000000000000000000000000000000000000', async () => {
    await contractNOIAToken.enableEtherlessTransfer({from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.transferPreSigned([77,118,123,174,196,207,199,89,97,232,142,171,99,170,165,215,57,204,55,23,169,7,20,128,0,198,147,133,185,60,186,130], "0x0000000000000000000000000000000000000000", 256, 6, 17,{from: accounts[0]}),'revert');
  });
  it('Should fail transferPreSigned(bytes,address,uint256,uint256,uint256) when NOT comply with: _to != 0x0000000000000000000000000000000000000000', async () => {
    await contractNOIAToken.enableEtherlessTransfer({from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.transferPreSigned([77,118,123,174,196,207,199,89,97,232,142,171,99,170,165,215,57,204,55,23,169,7,20,128,0,198,147,133,185,60,186,130], "0x0000000000000000000000000000000000000000", 256, 6, 17,{from: accounts[0]}),'revert');
  ...
  it('Should execute transferPreSigned(bytes,address,uint256,uint256,uint256) WHEN msg.sender!=_to,etherlessTransferEnabled==true,_to!=0x0000000000000000000000000000000000000000,from!=0x0000000000000000000000000000000000000000,hashedTxs==false', async () => {
    await contractNOIAToken.enableEtherlessTransfer({from:accounts[0]});
    let result = await contractNOIAToken.transferPreSigned([20,189,120,23,180,152,30,178,108,9,235,127,207,191,242,237,194,136,254,225,171,45,150,183,103,243,228,79,224,225,207,118], accounts[8], 1338, 17, 27,{from: accounts[2]});
  });
  it('Should fail transferPreSigned(bytes,address,uint256,uint256,uint256) when NOT comply with: etherlessTransferEnabled == true', async () => {
    await contractNOIAToken.enableEtherlessTransfer({from:accounts[0]});
    await contractNOIAToken.disableEtherlessTransfer({from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.transferPreSigned([20,189,120,23,180,152,30,178,108,9,235,127,207,191,242,237,194,136,254,225,171,45,150,183,103,243,228,79,224,225,207,118], accounts[8], 1338, 17, 27,{from: accounts[2]}),'revert');
  });
  it('Should fail transferPreSigned(bytes,address,uint256,uint256,uint256) when NOT comply with: _to != 0x0000000000000000000000000000000000000000', async () => {
    await contractNOIAToken.enableEtherlessTransfer({from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.transferPreSigned([20,189,120,23,180,152,30,178,108,9,235,127,207,191,242,237,194,136,254,225,171,45,150,183,103,243,228,79,224,225,207,118], "0x0000000000000000000000000000000000000000", 1338, 17, 27,{from: accounts[2]}),'revert');
  });
  it('Should execute hashForSign(bytes4,address,address,uint256,uint256,uint256)', async () => {
    let result = await contractNOIAToken.hashForSign([180,212,35,185], accounts[4], accounts[2], 5, 1338, 65,{from: accounts[0]});
  });
});
