...
contract("BondingCurve",(accounts)=>{
  ...
  it('Should execute buyTokens(uint256,uint256) WHEN supply>0', async () => {
    let result = await contractBondingCurve.buyTokens(99, 2,{from: accounts[0]});
  });
  it('Should execute buyTokens(uint256,uint256) WHEN supply<=0', async () => {
    await contractBondingCurve.sellTokens(129,{from:accounts[0]});
    let result = await contractBondingCurve.buyTokens(256, 3,{from: accounts[0]});
  });
  it('Should execute buyTokens(uint256,uint256) WHEN supply==0', async () => {
    await contractBondingCurve.sellTokens(9999,{from:accounts[0]});
    let result = await contractBondingCurve.buyTokens(9999, 1,{from: accounts[0]});
  });
  it('Should execute buyTokens(uint256,uint256) WHEN supply!=0', async () => {
    let result = await contractBondingCurve.buyTokens(256, 257,{from: accounts[0]});
  });
  it('Should execute sellTokens(uint256)', async () => {
    let result = await contractBondingCurve.sellTokens(10000,{from: accounts[0]});
  });
  it('Should execute changeTargetPrice(uint256)', async () => {
    let result = await contractBondingCurve.changeTargetPrice(3,{from: accounts[0]});
  });
  it('Should execute queryNextPrice() WHEN supply>0', async () => {
    let result = await contractBondingCurve.queryNextPrice({from: accounts[0]});
  });
  it('Should execute queryNextPrice() WHEN supply==0', async () => {
    await contractBondingCurve.buyTokens(0,255,{from:accounts[0]});
    let result = await contractBondingCurve.queryNextPrice({from: accounts[0]});
  });
  it('Should execute queryNextPrice() WHEN supply!=0', async () => {
    let result = await contractBondingCurve.queryNextPrice({from: accounts[0]});
