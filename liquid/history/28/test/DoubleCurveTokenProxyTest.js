...
contract("contractProxyDoubleCurveToken",(accounts)=>{
  ...
  it('Should execute testsolveForY(uint256) WHEN slopeD>0', async () => {
    await contractProxyDoubleCurveToken.methods["initialize(address,address,uint256,uint256,uint256,uint256,uint256,uint256,string,string,address)"](contractMockERC20.address,accounts[0],26,257,95,95,29,1,"\x19Ethereum Signed Message:\n32","\x19Ethereum Signed Message:\n32",contractGasPriceOracle.address,{from:accounts[0]});
  ...
  it('Should fail testsolveForY(uint256) when NOT comply with: slopeD > 0', async () => {
    await contractProxyDoubleCurveToken.methods["initialize(address,address,uint256,uint256,uint256,uint256,uint256,uint256,string,string,address)"](contractERC20.address,accounts[2],1532892062,0,96,1338,1532892064,256,"Example","whitelist",contractGasPriceOracle.address,{from:accounts[0]});
  ...
  it('Should execute testcurveIntegral(uint256) WHEN NumberLiteral ** NumberLiteral>0', async () => {
    let result = await contractProxyDoubleCurveToken.testcurveIntegral(1336,{from: accounts[0]});
  });
});
