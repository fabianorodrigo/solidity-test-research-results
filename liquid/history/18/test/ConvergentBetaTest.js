...
contract("ConvergentBeta",(accounts)=>{
  ...
  it('Should execute initialize(address,address) WHEN initialized!=true', async () => {
    let result = await contractConvergentBeta.methods["initialize(address,address)"](accounts[2], accounts[0],{from: accounts[0]});
  });
  it('Should execute setBaseAccount(address) WHEN msg.sender==_owner,_newBaseAccount!=0x0000000000000000000000000000000000000000', async () => {
    await contractConvergentBeta.methods["initialize(address,address)"](accounts[1],accounts[8],{from:accounts[0]});
  ...
  it('Should execute createAccount(address,uint256,uint256,uint256,uint256,uint256,uint256,bytes32,string,string)', async () => {
    let result = await contractConvergentBeta.createAccount(accounts[0], 4038714811, 257, 9, 4038714811, 4038714811, 3, [237,118,29,41,91,123,10,42,52,80,172,17,30,42,232,80,0,173,110,154,92,197,118,133,228,138,252,138,158,151,171,199], "IsLibrary", "UsesExample",{from: accounts[0]});
  });
