...
contract("ConvergentBeta",(accounts)=>{
  ...
  it('Should execute initialize(address,address) WHEN initialized!=true', async () => {
    let result = await contractConvergentBeta.methods["initialize(address,address)"](accounts[3], accounts[1],{from: accounts[0]});
  });
  it('Should execute setBaseAccount(address) WHEN msg.sender==_owner,_newBaseAccount!=0x0000000000000000000000000000000000000000', async () => {
    await contractConvergentBeta.methods["initialize(address,address)"](accounts[9],accounts[4],{from:accounts[0]});
  ...
  it('Should execute createAccount(address,uint256,uint256,uint256,uint256,uint256,uint256,bytes32,string,string)', async () => {
    let result = await contractConvergentBeta.createAccount(accounts[6], 1336, 97, 18, 66, 2014223715, 1338, [253,161,224,57,181,227,201,189,123,151,34,3,232,40,223,139,66,80,239,197,157,224,235,78,249,62,0,50,128,90,178,82], "IsLibrary", "Example",{from: accounts[0]});
  });
