...
contract("contractProxyDoubleCurveToken",(accounts)=>{
  ...
  it('Should execute testsolveForY(uint256) WHEN slopeD>0', async () => {
    await contractProxyDoubleCurveToken.methods["initialize(address,address,uint256,uint256,uint256,uint256,uint256,uint256,string,string,address)"](contractDoubleCurveToken.address,accounts[0],1532892063,256,255,2014223714,9999,1337,"whitelist","superuser",contractGasPriceOracle.address,{from:accounts[0]});
  ...
  it('Should fail testsolveForY(uint256) when NOT comply with: slopeD > 0', async () => {
    await contractProxyDoubleCurveToken.methods["initialize(address,address,uint256,uint256,uint256,uint256,uint256,uint256,string,string,address)"](contractERC20.address,accounts[3],95,0,1532892062,255,19,11,"RevertWithReason","initialize(address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes32,string,string,address)",contractGasPriceOracle.address,{from:accounts[0]});
  ...
  it('Should execute testcurveIntegral(uint256) WHEN NumberLiteral ** NumberLiteral>0', async () => {
    let result = await contractProxyDoubleCurveToken.testcurveIntegral(256,{from: accounts[0]});
  });
});
