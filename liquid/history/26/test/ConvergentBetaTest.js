...
contract("ConvergentBeta",(accounts)=>{
  ...
  it('Should execute initialize(address,address) WHEN initialized!=true', async () => {
    let result = await contractConvergentBeta.methods["initialize(address,address)"](accounts[5], accounts[5],{from: accounts[0]});
  });
  it('Should execute setBaseAccount(address) WHEN msg.sender==_owner,_newBaseAccount!=0x0000000000000000000000000000000000000000', async () => {
    await contractConvergentBeta.methods["initialize(address,address)"](accounts[8],accounts[6],{from:accounts[0]});
  ...
  it('Should execute createAccount(address,uint256,uint256,uint256,uint256,uint256,uint256,bytes32,string,string)', async () => {
    let result = await contractConvergentBeta.createAccount(accounts[3], 11, 64, 1532892064, 5, 95, 10001, [46,210,251,114,54,173,221,49,29,8,123,200,252,226,69,189,211,49,184,189,158,87,180,30,167,140,94,125,170,127,195,139], "PayableExample", "RevertWithReason",{from: accounts[0]});
  });
