...
contract("ERC721MintableComplete",(accounts)=>{
  ...
  it('Should execute mint(address,uint256) WHEN msg.sender==_owner,to!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractERC721MintableComplete.mint(accounts[0], 59,{from: accounts[0]});
  });
  it('Should fail mint(address,uint256) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractERC721MintableComplete.mint(accounts[0], 59,{from: accounts[9]}),'revert');
  });
  it('Should fail mint(address,uint256) when NOT comply with: to != 0x0000000000000000000000000000000000000000', async () => {
    let result = await truffleAssert.fails(contractERC721MintableComplete.mint("0x0000000000000000000000000000000000000000", 59,{from: accounts[0]}),'revert');
  });
});
