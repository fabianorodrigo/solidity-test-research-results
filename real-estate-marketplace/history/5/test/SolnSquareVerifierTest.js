...
contract("SolnSquareVerifier",(accounts)=>{
  ...
  it('Should execute addSolution(uint256,address,uint[2],uint[2][2],uint[2],uint[2]) WHEN solutionKeyToSubmissionStatus!=true', async () => {
    let result = await contractSolnSquareVerifier.addSolution(48, accounts[7], [10,47], [[24,22],[45,98]], [102,45], [59,45],{from: accounts[0]});
  });
  it('Should execute mint(address,uint256)', async () => {
    let result = await contractSolnSquareVerifier.mint(accounts[6], 7,{from: accounts[0]});
  });
});
