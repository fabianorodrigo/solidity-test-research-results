...
contract("ERC721Enumerable",(accounts)=>{
  ...
  it('Should execute tokenOfOwnerByIndex(address,uint256)', async () => {
    let result = await contractERC721Enumerable.tokenOfOwnerByIndex(accounts[5], 70,{from: accounts[0]});
  });
  ...
  it('Should execute tokenByIndex(uint256)', async () => {
    let result = await contractERC721Enumerable.tokenByIndex(9,{from: accounts[0]});
  });
});
