...
contract("contractProxyPairing",(accounts)=>{
  ...
  it('Should execute testnegate(Pairing.G1Point) WHEN p.Y!=0', async () => {
    let result = await contractProxyPairing.testnegate({"X": 48,"Y": 18},{from: accounts[0]});
  });
  it('Should execute testaddition0(Pairing.G1Point,Pairing.G1Point)', async () => {
    let result = await contractProxyPairing.testaddition0({"X": 29,"Y": 28}, {"X": 3,"Y": 33},{from: accounts[0]});
  });
  it('Should execute testaddition1(Pairing.G2Point,Pairing.G2Point)', async () => {
    let result = await contractProxyPairing.testaddition1({"X": [18,88],"Y": [86,86]}, {"X": [97,1532892063],"Y": [70,69]},{from: accounts[0]});
  });
  it('Should execute testscalar_mul(Pairing.G1Point,uint)', async () => {
    let result = await contractProxyPairing.testscalar_mul({"X": 59,"Y": 1532892062}, 161,{from: accounts[0]});
  });
  it('Should execute testpairing(Pairing.G1Point[],Pairing.G2Point[]) WHEN p1.length==p2.length', async () => {
    let result = await contractProxyPairing.testpairing([{"X": 33,"Y": 102},{"X": 66,"Y": 31},{"X": 25,"Y": 30},{"X": 200001,"Y": 32},{"X": 49,"Y": 57},{"X": 23,"Y": 2},{"X": 1532892062,"Y": 54},{"X": 55,"Y": 162},{"X": 128,"Y": 127},{"X": 23,"Y": 55}], [{"X": [64,257],"Y": [86,3]},{"X": [70,1532892064],"Y": [1532892062,3]},{"X": [96,127],"Y": [15,56]},{"X": [15,102],"Y": [15,16]},{"X": [64,257],"Y": [8,18]},{"X": [19,2014223716],"Y": [47,1532892062]},{"X": [97,161],"Y": [97,9]},{"X": [1532892062,54],"Y": [59,98]},{"X": [95,8],"Y": [254,8]},{"X": [19,2014223715],"Y": [66,57]}],{from: accounts[0]});
  });
  it('Should fail testpairing(Pairing.G1Point[],Pairing.G2Point[]) when NOT comply with: p1.length == p2.length', async () => {
    let result = await truffleAssert.fails(contractProxyPairing.testpairing([{"X": 2,"Y": 160},{"X": 19,"Y": 86},{"X": 256,"Y": 254},{"X": 1023,"Y": 26},{"X": 32,"Y": 29},{"X": 2014223714,"Y": 23},{"X": 95,"Y": 22},{"X": 254,"Y": 3},{"X": 71,"Y": 70},{"X": 31,"Y": 58},{"X": 49,"Y": 29}], [{"X": [64,257],"Y": [86,3]},{"X": [70,1532892064],"Y": [1532892062,3]},{"X": [96,127],"Y": [15,56]},{"X": [15,102],"Y": [15,16]},{"X": [64,257],"Y": [8,18]},{"X": [19,2014223716],"Y": [47,1532892062]},{"X": [97,161],"Y": [97,9]},{"X": [1532892062,54],"Y": [59,98]},{"X": [95,8],"Y": [254,8]},{"X": [19,2014223715],"Y": [66,57]}],{from: accounts[0]}),'revert');
  });
  it('Should execute testpairingProd2(Pairing.G1Point,Pairing.G2Point,Pairing.G1Point,Pairing.G2Point)', async () => {
    let result = await contractProxyPairing.testpairingProd2({"X": 129,"Y": 30}, {"X": [48,129],"Y": [57,1023]}, {"X": 25,"Y": 59}, {"X": [9,29],"Y": [49,102]},{from: accounts[0]});
  });
  it('Should execute testpairingProd3(Pairing.G1Point,Pairing.G2Point,Pairing.G1Point,Pairing.G2Point,Pairing.G1Point,Pairing.G2Point)', async () => {
    let result = await contractProxyPairing.testpairingProd3({"X": 199999,"Y": 23}, {"X": [59,2014223716],"Y": [20,57]}, {"X": 86,"Y": 33}, {"X": [256,58],"Y": [47,56]}, {"X": 200000,"Y": 47}, {"X": [66,199999],"Y": [10,15]},{from: accounts[0]});
  });
});
