...
contract("CustomAdmin",(accounts)=>{
  ...
  it('Should execute addManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.addManyAdmins([accounts[7],accounts[7],accounts[0],accounts[8],accounts[4],accounts[4]],{from: accounts[0]});
  });
  ...
  it('Should execute removeManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.removeManyAdmins([accounts[2],accounts[1],accounts[4],accounts[9],accounts[7],accounts[4],accounts[6],accounts[6]],{from: accounts[0]});
  });
