...
contract("BulkTransfer",(accounts)=>{
  ...
  it('Should execute bulkTransfer(address,address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[6],accounts[8],accounts[3],accounts[8],accounts[4],accounts[1],accounts[3],accounts[8]], [5,19,1532892062,2014223714,1532892063,1,66,64],{from: accounts[0]});
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: _paused != true', async () => {
    ...
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[6],accounts[8],accounts[3],accounts[8],accounts[4],accounts[1],accounts[3],accounts[8]], [5,19,1532892062,2014223714,1532892063,1,66,64],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[3],accounts[2],accounts[9],accounts[8],accounts[5],accounts[6],accounts[3],accounts[9],accounts[7]], [5,19,1532892062,2014223714,1532892063,1,66,64],{from: accounts[0]}),'revert');
  });
  it('Should execute bulkTransferEther(address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransferEther([accounts[8],accounts[4],accounts[3],accounts[3],accounts[6],accounts[2],accounts[9],accounts[4],accounts[3]], [1532892064,1,28,3,1532892063,29,0,1532892064,4],{from: accounts[0]});
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: _paused != true', async () => {
    await contractBulkTransfer.pause({from:accounts[0]});
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[8],accounts[4],accounts[3],accounts[3],accounts[6],accounts[2],accounts[9],accounts[4],accounts[3]], [1532892064,1,28,3,1532892063,29,0,1532892064,4],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[7],accounts[6],accounts[9],accounts[4],accounts[9],accounts[6],accounts[8],accounts[8],accounts[1],accounts[7]], [1532892064,1,28,3,1532892063,29,0,1532892064,4],{from: accounts[0]}),'revert');
  });
});
