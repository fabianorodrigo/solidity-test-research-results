...
contract("BulkTransfer",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractSimpleToken = await SimpleToken.new({from:accounts[1]});
    if(trace) console.log('SUCESSO: SimpleToken.new({from:accounts[1]}');
  ...
  it('Should execute bulkTransfer(address,address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[8],accounts[0],accounts[3],accounts[1],accounts[1],accounts[8],accounts[1],accounts[0],accounts[9],accounts[3]], [256,255,96,97,2014223715,26,17,2014223716,2014223716,1],{from: accounts[0]});
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: _paused != true', async () => {
    ...
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[8],accounts[0],accounts[3],accounts[1],accounts[1],accounts[8],accounts[1],accounts[0],accounts[9],accounts[3]], [256,255,96,97,2014223715,26,17,2014223716,2014223716,1],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[6],accounts[9],accounts[3],accounts[5],accounts[9],accounts[4],accounts[9],accounts[1],accounts[2],accounts[2],accounts[7]], [256,255,96,97,2014223715,26,17,2014223716,2014223716,1],{from: accounts[0]}),'revert');
  });
  it('Should execute bulkTransferEther(address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransferEther([accounts[6],accounts[1],accounts[6],accounts[8],accounts[0],accounts[4],accounts[7]], [26,5,27,1532892064,28,4,66],{from: accounts[0]});
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: _paused != true', async () => {
    await contractBulkTransfer.pause({from:accounts[0]});
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[6],accounts[1],accounts[6],accounts[8],accounts[0],accounts[4],accounts[7]], [26,5,27,1532892064,28,4,66],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[9],accounts[6],accounts[4],accounts[2],accounts[8],accounts[0],accounts[7],accounts[4]], [26,5,27,1532892064,28,4,66],{from: accounts[0]}),'revert');
  });
});
