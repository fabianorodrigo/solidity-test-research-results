...
contract("CustomAdmin",(accounts)=>{
  ...
  it('Should execute addManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.addManyAdmins([accounts[3],accounts[7],accounts[5],accounts[7],accounts[9],accounts[5]],{from: accounts[0]});
  });
  ...
  it('Should execute removeManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.removeManyAdmins([accounts[4]],{from: accounts[0]});
  });
  it('Should execute isAdmin(address)', async () => {
    let result = await contractCustomAdmin.isAdmin(accounts[2],{from: accounts[0]});
  });
});
