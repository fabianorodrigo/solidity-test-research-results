...
contract("CustomAdmin",(accounts)=>{
  ...
  it('Should execute addAdmin(address) WHEN account!=0x0000000000000000000000000000000000000000,_admins!=true', async () => {
    let result = await contractCustomAdmin.addAdmin(accounts[4],{from: accounts[0]});
  });
  ...
  it('Should execute addManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.addManyAdmins([accounts[2]],{from: accounts[0]});
  });
  ...
  it('Should execute removeManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.removeManyAdmins([accounts[9],accounts[3],accounts[4],accounts[5],accounts[3],accounts[8],accounts[2],accounts[0],accounts[1]],{from: accounts[0]});
  });
