...
contract("BulkTransfer",(accounts)=>{
  ...
  it('Should execute bulkTransfer(address,address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[4],accounts[0],accounts[6],accounts[2],accounts[0]], [2,2014223716,255,26,2014223714],{from: accounts[0]});
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: _paused != true', async () => {
    ...
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[4],accounts[0],accounts[6],accounts[2],accounts[0]], [2,2014223716,255,26,2014223714],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[1],accounts[6],accounts[6],accounts[8],accounts[8],accounts[3]], [2,2014223716,255,26,2014223714],{from: accounts[0]}),'revert');
  });
  it('Should execute bulkTransferEther(address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransferEther([accounts[7],accounts[6],accounts[3],accounts[3],accounts[3],accounts[6],accounts[1],accounts[7],accounts[6]], [27,255,1,1532892064,1532892064,64,254,2014223715,1532892063],{from: accounts[0]});
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: _paused != true', async () => {
    await contractBulkTransfer.pause({from:accounts[0]});
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[7],accounts[6],accounts[3],accounts[3],accounts[3],accounts[6],accounts[1],accounts[7],accounts[6]], [27,255,1,1532892064,1532892064,64,254,2014223715,1532892063],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[6],accounts[6],accounts[9],accounts[7],accounts[7],accounts[1],accounts[5],accounts[6],accounts[4],accounts[6]], [27,255,1,1532892064,1532892064,64,254,2014223715,1532892063],{from: accounts[0]}),'revert');
  });
});
