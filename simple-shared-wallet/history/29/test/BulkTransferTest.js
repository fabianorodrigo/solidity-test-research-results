...
contract("BulkTransfer",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractSimpleToken = await SimpleToken.new({from:accounts[5]});
    if(trace) console.log('SUCESSO: SimpleToken.new({from:accounts[5]}');
  ...
  it('Should execute bulkTransfer(address,address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[6],accounts[5],accounts[4],accounts[2],accounts[8],accounts[9],accounts[0],accounts[2]], [256,27,65,1532892062,3,96,2014223716,96],{from: accounts[0]});
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: _paused != true', async () => {
    ...
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[6],accounts[5],accounts[4],accounts[2],accounts[8],accounts[9],accounts[0],accounts[2]], [256,27,65,1532892062,3,96,2014223716,96],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[8],accounts[9],accounts[2],accounts[4],accounts[7],accounts[0],accounts[8],accounts[0],accounts[7]], [256,27,65,1532892062,3,96,2014223716,96],{from: accounts[0]}),'revert');
  });
  it('Should execute bulkTransferEther(address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransferEther([accounts[3],accounts[5],accounts[5],accounts[2],accounts[8],accounts[7],accounts[6],accounts[8],accounts[5]], [1532892064,2,2014223716,27,1532892062,29,17,66,255],{from: accounts[0]});
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: _paused != true', async () => {
    await contractBulkTransfer.pause({from:accounts[0]});
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[3],accounts[5],accounts[5],accounts[2],accounts[8],accounts[7],accounts[6],accounts[8],accounts[5]], [1532892064,2,2014223716,27,1532892062,29,17,66,255],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[9],accounts[1],accounts[4],accounts[3],accounts[7],accounts[2],accounts[3],accounts[2],accounts[3],accounts[4]], [1532892064,2,2014223716,27,1532892062,29,17,66,255],{from: accounts[0]}),'revert');
  });
});
