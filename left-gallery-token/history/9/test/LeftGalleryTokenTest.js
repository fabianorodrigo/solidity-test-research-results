...
contract("LeftGalleryToken",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractERC721Token = await ERC721Token.new("lgmm","lgfile",{from:accounts[0]});
    if(trace) console.log('SUCESSO: ERC721Token.new("lgmm","lgfile",{from:accounts[0]}');
    ...
    contractToken = await Token.new("","minter",1532892063,{from:accounts[0]});
    if(trace) console.log('SUCESSO: Token.new("","minter",1532892063,{from:accounts[0]}');
  ...
  it('Should execute tokenURI(uint256)', async () => {
    let result = await contractLeftGalleryToken.tokenURI(33,{from: accounts[0]});
  });
  it('Should execute tokenOfOwnerByIndex(address,uint256)', async () => {
    let result = await contractLeftGalleryToken.tokenOfOwnerByIndex(accounts[6], 31,{from: accounts[0]});
  });
  ...
  it('Should execute tokenByIndex(uint256)', async () => {
    let result = await contractLeftGalleryToken.tokenByIndex(1532892063,{from: accounts[0]});
  });
  it('Should execute createWork(address,string) WHEN msg.sender==owner,_to!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractLeftGalleryToken.createWork(accounts[1], "autobreeder (lite) by harm van den dorpel, 2016, 100 editions",{from: accounts[0]});
  });
  it('Should fail createWork(address,string) when NOT comply with: msg.sender == owner', async () => {
    let result = await truffleAssert.fails(contractLeftGalleryToken.createWork(accounts[1], "autobreeder (lite) by harm van den dorpel, 2016, 100 editions",{from: accounts[9]}),'revert');
  });
  it('Should fail createWork(address,string) when NOT comply with: _to != 0x0000000000000000000000000000000000000000', async () => {
    let result = await truffleAssert.fails(contractLeftGalleryToken.createWork("0x0000000000000000000000000000000000000000", "autobreeder (lite) by harm van den dorpel, 2016, 100 editions",{from: accounts[0]}),'revert');
  });
});
