...
contract("contractProxyDebuggable",(accounts)=>{
  ...
  it('Should execute testdebug0(string)', async () => {
    let result = await contractProxyDebuggable.testdebug0("tpyqln",{from: accounts[0]});
  });
  it('Should execute testdebug1(bytes32)', async () => {
    let result = await contractProxyDebuggable.testdebug1([10,167,2,22,148,6,114,42,80,214,185,184,13,183,125,243,92,109,121,202,55,107,239,221,248,31,206,46,90,41,136,4],{from: accounts[0]});
  });
  ...
  it('Should execute testdebugRevert1(string)', async () => {
    let result = await contractProxyDebuggable.testdebugRevert1("tpyqln",{from: accounts[0]});
  });
