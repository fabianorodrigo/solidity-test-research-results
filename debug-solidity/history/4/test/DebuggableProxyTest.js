...
contract("contractProxyDebuggable",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractDebugCounter = await DebugCounter.new("svusty",{from:accounts[0]});
    if(trace) console.log('SUCESSO: DebugCounter.new("svusty",{from:accounts[0]}');
  ...
  it('Should execute testdebug0(string)', async () => {
    let result = await contractProxyDebuggable.testdebug0("svusty",{from: accounts[0]});
  });
  it('Should execute testdebug1(bytes32)', async () => {
    let result = await contractProxyDebuggable.testdebug1([167,34,245,177,3,97,248,214,176,17,166,47,68,108,12,169,38,218,145,249,134,118,124,77,194,220,71,75,183,15,147,156],{from: accounts[0]});
  });
  ...
  it('Should execute testdebugRevert1(string)', async () => {
    let result = await contractProxyDebuggable.testdebugRevert1("qx7lpk",{from: accounts[0]});
  });
