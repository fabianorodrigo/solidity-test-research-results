...
contract("contractProxyDebuggable",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractDebugCounter = await DebugCounter.new("p7sf2",{from:accounts[0]});
    if(trace) console.log('SUCESSO: DebugCounter.new("p7sf2",{from:accounts[0]}');
  ...
  it('Should execute testdebug0(string)', async () => {
    let result = await contractProxyDebuggable.testdebug0("p7sf2",{from: accounts[0]});
  });
  it('Should execute testdebug1(bytes32)', async () => {
    let result = await contractProxyDebuggable.testdebug1([101,226,169,116,113,55,82,154,28,213,99,218,74,145,240,186,43,25,228,198,195,133,54,152,146,237,236,100,228,184,241,179],{from: accounts[0]});
  });
  it('Should execute testdebug2(uint256)', async () => {
    let result = await contractProxyDebuggable.testdebug2(256,{from: accounts[0]});
  });
  ...
  it('Should execute testdebugRevert1(string)', async () => {
    let result = await contractProxyDebuggable.testdebugRevert1("hnmx3",{from: accounts[0]});
  });
