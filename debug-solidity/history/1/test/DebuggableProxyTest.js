...
contract("contractProxyDebuggable",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractDebugCounter = await DebugCounter.new("gganol",{from:accounts[0]});
    if(trace) console.log('SUCESSO: DebugCounter.new("gganol",{from:accounts[0]}');
  ...
  it('Should execute testdebug0(string)', async () => {
    let result = await contractProxyDebuggable.testdebug0("gganol",{from: accounts[0]});
  });
  it('Should execute testdebug1(bytes32)', async () => {
    let result = await contractProxyDebuggable.testdebug1([232,139,247,13,179,86,213,27,21,238,46,211,160,53,136,205,69,76,71,199,139,210,118,49,208,156,34,168,72,120,79,239],{from: accounts[0]});
  });
  it('Should execute testdebug2(uint256)', async () => {
    let result = await contractProxyDebuggable.testdebug2(4,{from: accounts[0]});
  });
  ...
  it('Should execute testdebugRevert1(string)', async () => {
    let result = await contractProxyDebuggable.testdebugRevert1("gganol",{from: accounts[0]});
  });
