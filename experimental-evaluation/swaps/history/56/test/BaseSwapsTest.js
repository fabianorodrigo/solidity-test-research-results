...
contract("BaseSwaps",(accounts)=>{
  ...
  it('Should execute fallback() WHEN baseAddress==0x0000000000000000000000000000000000000000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[7],"0x0000000000000000000000000000000000000000",accounts[2],10001,28,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+767,{from:accounts[0]});
  ...
  it('Should fail fallback() when NOT comply with: baseAddress == 0x0000000000000000000000000000000000000000', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[6],accounts[8],accounts[3],29,1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+935,{from:accounts[0]});
  ...
  it('Should execute depositBaseTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositBaseTokens(1337,{from: accounts[0]});
  });
  it('Should execute depositQuoteTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositQuoteTokens(256,{from: accounts[0]});
  });
  ...
  it('Should fail cancel() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[1],accounts[0],"0x0000000000000000000000000000000000000000",1336,6,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+604,{from:accounts[0]});
  ...
  it('Should fail refundBase() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[7],accounts[7],"0x0000000000000000000000000000000000000000",256,255,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+854,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should fail refundQuote() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[4],accounts[0],"0x0000000000000000000000000000000000000000",97,1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+401,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should execute quoteUserInvestment(address)', async () => {
    let result = await contractBaseSwaps.quoteUserInvestment(accounts[6],{from: accounts[0]});
  });
