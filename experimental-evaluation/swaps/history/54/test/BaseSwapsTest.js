...
contract("BaseSwaps",(accounts)=>{
  ...
  it('Should execute fallback() WHEN baseAddress==0x0000000000000000000000000000000000000000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[4],"0x0000000000000000000000000000000000000000",accounts[8],10001,97,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+108,{from:accounts[0]});
  ...
  it('Should fail fallback() when NOT comply with: baseAddress == 0x0000000000000000000000000000000000000000', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[9],accounts[9],accounts[6],6,254,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+547,{from:accounts[0]});
  ...
  it('Should execute depositBaseTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositBaseTokens(2,{from: accounts[0]});
  });
  it('Should execute depositQuoteTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositQuoteTokens(257,{from: accounts[0]});
  });
  ...
  it('Should fail cancel() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[9],accounts[4],"0x0000000000000000000000000000000000000000",10001,4038714810,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+836,{from:accounts[0]});
  ...
  it('Should fail refundBase() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[6],"0x0000000000000000000000000000000000000000",accounts[7],10001,65,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+390,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should fail refundQuote() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[0],"0x0000000000000000000000000000000000000000",accounts[9],1338,5,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+895,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
