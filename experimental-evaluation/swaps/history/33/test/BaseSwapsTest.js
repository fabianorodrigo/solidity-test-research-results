...
contract("BaseSwaps",(accounts)=>{
  ...
  it('Should execute fallback() WHEN quoteAddress==0x0000000000000000000000000000000000000000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[1],accounts[1],"0x0000000000000000000000000000000000000000",29,66,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+595,{from:accounts[0]});
  ...
  it('Should fail fallback() when NOT comply with: quoteAddress == 0x0000000000000000000000000000000000000000', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[1],accounts[9],accounts[8],10,96,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+69,{from:accounts[0]});
  ...
  it('Should execute depositBaseTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositBaseTokens(4038714810,{from: accounts[0]});
  });
  ...
  it('Should fail cancel() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[5],"0x0000000000000000000000000000000000000000",accounts[6],255,6,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+507,{from:accounts[0]});
  ...
  it('Should fail refundBase() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[6],"0x0000000000000000000000000000000000000000",accounts[7],254,10000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+34,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should fail refundQuote() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[6],accounts[9],"0x0000000000000000000000000000000000000000",1532892063,4038714810,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+305,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
