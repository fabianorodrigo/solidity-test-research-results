...
contract("BaseSwaps",(accounts)=>{
  ...
  it('Should execute fallback() WHEN baseAddress==0x0000000000000000000000000000000000000000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[4],"0x0000000000000000000000000000000000000000",accounts[3],66,65,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+127,{from:accounts[0]});
  ...
  it('Should fail fallback() when NOT comply with: baseAddress == 0x0000000000000000000000000000000000000000', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[5],accounts[9],accounts[0],4,1338,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+680,{from:accounts[0]});
  ...
  it('Should execute depositBaseTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositBaseTokens(4038714809,{from: accounts[0]});
  });
  it('Should execute depositQuoteTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositQuoteTokens(10,{from: accounts[0]});
  });
  ...
  it('Should fail cancel() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[7],"0x0000000000000000000000000000000000000000",accounts[7],5,65,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+165,{from:accounts[0]});
  ...
  it('Should fail refundBase() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[4],"0x0000000000000000000000000000000000000000",accounts[2],6,65,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+570,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should fail refundQuote() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[3],accounts[1],"0x0000000000000000000000000000000000000000",254,11,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+635,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
