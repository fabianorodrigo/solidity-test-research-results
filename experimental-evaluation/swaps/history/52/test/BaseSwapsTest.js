...
contract("BaseSwaps",(accounts)=>{
  ...
  it('Should execute fallback() WHEN quoteAddress==0x0000000000000000000000000000000000000000,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[6],accounts[0],"0x0000000000000000000000000000000000000000",4038714810,6,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+43,{from:accounts[0]});
  ...
  it('Should fail fallback() when NOT comply with: quoteAddress == 0x0000000000000000000000000000000000000000', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[7],accounts[3],accounts[2],97,5,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+287,{from:accounts[0]});
  ...
  it('Should execute depositBaseTokens(uint) WHEN _value<=allowance,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<=expirationTimestamp', async () => {
    let result = await contractBaseSwaps.depositBaseTokens(11,{from: accounts[0]});
  });
  ...
  it('Should fail cancel() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[7],accounts[7],"0x0000000000000000000000000000000000000000",4038714811,1338,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+488,{from:accounts[0]});
  ...
  it('Should fail refundBase() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[5],accounts[9],"0x0000000000000000000000000000000000000000",256,66,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+218,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should fail refundQuote() when NOT comply with: isSwapped != true', async () => {
    let localBaseSwaps = await BaseSwaps.new(accounts[2],"0x0000000000000000000000000000000000000000",accounts[2],95,1532892062,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+196,{from:accounts[0]});
    await localBaseSwaps.sendTransaction({from:accounts[0]});
  ...
  it('Should execute baseUserInvestment(address)', async () => {
    let result = await contractBaseSwaps.baseUserInvestment(accounts[0],{from: accounts[0]});
  });
