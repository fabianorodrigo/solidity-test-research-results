...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(1532892062,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[4],28,254,{from:accounts[9]});
});
