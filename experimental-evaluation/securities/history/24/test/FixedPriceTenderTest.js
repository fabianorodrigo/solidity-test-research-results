...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(64,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[2],2,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+509,{from:accounts[9]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+317,{from: accounts[9]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(64,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[2],2,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+509,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+317,{from: accounts[8]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892064,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[5],1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+631,{from:accounts[9]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(29,{from: accounts[9]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892064,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[5],1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+631,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(29,{from: accounts[8]}),'revert');
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[2],2014223716,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+832,{from:accounts[9]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(255,{from: accounts[9]});
  });
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[2],2014223716,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+832,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(255,{from: accounts[8]}),'revert');
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1336,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[3],5,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+763,{from:accounts[9]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[9]});
    let result = await localFixedPriceTender.optInToTender(256,{from: accounts[9]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1336,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[3],5,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+763,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(256,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[5],2014223716,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+165,{from:accounts[9]});
    let result = await localFixedPriceTender.optOutOfTender(2,{from: accounts[9]});
  });
  ...
  it('Should execute finaliseTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp>=offerEndTime,nextTenderToAssess<orderedHolders.length,_batchSize>0', async () => {
    let result = await contractFixedPriceTender.finaliseTender(1532892064,{from: accounts[0]});
  });
