...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(1337,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[0],5,5,{from:accounts[9]});
});
