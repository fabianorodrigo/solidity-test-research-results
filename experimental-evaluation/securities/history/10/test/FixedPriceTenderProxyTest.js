...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(27,contractRedeemableToken.address,contractRedeemableTokenMock.address,contractECDSA.address,4,1,{from:accounts[9]});
});
