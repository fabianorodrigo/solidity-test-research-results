...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(9999,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[1],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+31,{from:accounts[9]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+163,{from: accounts[9]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(9999,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[1],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+31,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+163,{from: accounts[8]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(9999,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[5],65,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+451,{from:accounts[9]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(26,{from: accounts[9]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(9999,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[5],65,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+451,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(26,{from: accounts[8]}),'revert');
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[6],257,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+209,{from:accounts[9]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(2014223714,{from: accounts[9]});
  });
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[6],257,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+209,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(2014223714,{from: accounts[8]}),'revert');
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(27,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[4],96,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+638,{from:accounts[9]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[9]});
    let result = await localFixedPriceTender.optInToTender(254,{from: accounts[9]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(27,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[4],96,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+638,{from:accounts[9]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(254,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(3,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[8],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+403,{from:accounts[9]});
    let result = await localFixedPriceTender.optOutOfTender(254,{from: accounts[9]});
  });
