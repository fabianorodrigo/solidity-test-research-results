...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[4],1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+460,{from:accounts[0]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+662,{from: accounts[0]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[4],1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+460,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+662,{from: accounts[9]}),'revert');
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: _newOfferEnd >= (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[4],1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+460,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp-1,{from: accounts[0]}),'revert');
  });
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[2],1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+629,{from:accounts[0]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(1532892063,{from: accounts[0]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[2],1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+629,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(1532892063,{from: accounts[9]}),'revert');
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: _newPaymentPerSecurity > 0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892062,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[2],1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+629,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(0,{from: accounts[0]}),'revert');
  });
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(28,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[3],1338,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+500,{from:accounts[0]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(257,{from: accounts[0]});
  });
  ...
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: _newTotalToRepurchase >= 0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(28,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[3],1338,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+500,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(-1,{from: accounts[0]}),'revert');
  });
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[0],0,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+268,{from:accounts[0]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[0]});
    let result = await localFixedPriceTender.optInToTender(2014223715,{from: accounts[0]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[0],0,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+268,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(2014223715,{from: accounts[0]}),'revert');
  });
  it('Should fail optInToTender(uint256) when NOT comply with: _numberToTender > 0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[0],0,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+268,{from:accounts[0]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(0,{from: accounts[0]}),'revert');
  });
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1338,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[9],6,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+797,{from:accounts[0]});
    let result = await localFixedPriceTender.optOutOfTender(5,{from: accounts[0]});
  });
  it('Should fail optOutOfTender(uint256) when NOT comply with: _numberToRemove > 0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1338,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[9],6,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+797,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.optOutOfTender(0,{from: accounts[0]}),'revert');
  });
  it('Should execute finaliseTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp>=offerEndTime,nextTenderToAssess<orderedHolders.length,_batchSize>0', async () => {
    let result = await contractFixedPriceTender.finaliseTender(3,{from: accounts[0]});
  });
