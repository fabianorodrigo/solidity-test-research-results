...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(6,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[1],27,9999,{from:accounts[0]});
});
