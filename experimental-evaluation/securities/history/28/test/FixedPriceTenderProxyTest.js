...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(1336,contractPaymentTokenMock.address,contractPaymentTokenMock.address,contractMath.address,10001,2014223714,{from:accounts[1]});
});
