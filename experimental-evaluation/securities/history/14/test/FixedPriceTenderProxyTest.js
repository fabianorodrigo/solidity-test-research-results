...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(10000,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[0],2,27,{from:accounts[1]});
});
