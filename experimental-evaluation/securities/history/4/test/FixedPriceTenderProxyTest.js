...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(3,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[2],6,256,{from:accounts[5]});
});
