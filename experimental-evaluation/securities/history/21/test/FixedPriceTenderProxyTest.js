...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(1,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[1],26,5,{from:accounts[7]});
});
