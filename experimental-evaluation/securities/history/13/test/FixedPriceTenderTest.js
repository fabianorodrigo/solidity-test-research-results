...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(4,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[8],256,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+965,{from:accounts[7]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+298,{from: accounts[7]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(4,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[8],256,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+965,{from:accounts[7]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+298,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(254,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[3],28,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+547,{from:accounts[7]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(1336,{from: accounts[7]});
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(28,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[7],26,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+349,{from:accounts[7]});
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(97,contractRedeemableToken.address,contractRedeemableTokenMock.address,accounts[5],1336,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+564,{from:accounts[7]});
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(4,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[9],9999,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+481,{from:accounts[7]});
    let result = await localFixedPriceTender.optOutOfTender(1532892063,{from: accounts[7]});
  });
  ...
  it('Should execute finaliseTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp>=offerEndTime,nextTenderToAssess<orderedHolders.length,_batchSize>0', async () => {
    let result = await contractFixedPriceTender.finaliseTender(28,{from: accounts[0]});
  });
