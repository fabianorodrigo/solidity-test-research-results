...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(254,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[8],1337,10000,{from:accounts[0]});
});
