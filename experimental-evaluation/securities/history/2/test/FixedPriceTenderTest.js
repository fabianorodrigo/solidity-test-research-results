...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[4],27,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+99,{from:accounts[8]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+51,{from: accounts[8]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[4],27,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+99,{from:accounts[8]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+51,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[4],254,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+60,{from:accounts[8]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(66,{from: accounts[8]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(5,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[4],254,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+60,{from:accounts[8]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(66,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1532892064,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[8],97,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+407,{from:accounts[8]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(1532892064,{from: accounts[8]});
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1338,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[0],66,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+759,{from:accounts[8]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[8]});
    let result = await localFixedPriceTender.optInToTender(1338,{from: accounts[8]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1338,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[0],66,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+759,{from:accounts[8]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(1338,{from: accounts[8]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(64,contractPaymentTokenMock.address,contractRedeemableToken.address,accounts[3],66,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+426,{from:accounts[8]});
    let result = await localFixedPriceTender.optOutOfTender(254,{from: accounts[8]});
  });
