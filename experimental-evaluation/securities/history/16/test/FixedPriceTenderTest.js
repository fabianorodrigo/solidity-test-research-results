...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[7],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+395,{from:accounts[6]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+951,{from: accounts[6]});
  });
  it('Should fail updateOfferEndTime(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1,contractRedeemableTokenMock.address,contractRedeemableTokenMock.address,accounts[7],3,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+395,{from:accounts[6]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+951,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(95,contractPaymentTokenMock.address,contractRedeemableTokenMock.address,accounts[9],2014223716,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+295,{from:accounts[6]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(1338,{from: accounts[6]});
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[5],64,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+911,{from:accounts[6]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(65,{from: accounts[6]});
  });
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(1,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[5],64,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+911,{from:accounts[6]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(65,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(10001,contractRedeemableToken.address,contractRedeemableToken.address,accounts[5],95,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+289,{from:accounts[6]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[6]});
    let result = await localFixedPriceTender.optInToTender(254,{from: accounts[6]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(10001,contractRedeemableToken.address,contractRedeemableToken.address,accounts[5],95,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+289,{from:accounts[6]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(254,{from: accounts[6]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(6,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[2],4,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+559,{from:accounts[6]});
    let result = await localFixedPriceTender.optOutOfTender(6,{from: accounts[6]});
  });
