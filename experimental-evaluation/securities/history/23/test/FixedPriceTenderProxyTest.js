...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(9999,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[5],1,26,{from:accounts[4]});
});
