...
contract("PartialRedemption",(accounts)=>{
  ...
  it('Should execute redeemTokens(address[],uint256[]) WHEN msg.sender==_owner,_holders.length==_numberOfTokens.length,_holders.length>0', async () => {
    let result = await contractPartialRedemption.redeemTokens([accounts[1],accounts[3],accounts[5],accounts[0],accounts[0],accounts[7],accounts[5],accounts[2],accounts[5],accounts[0],accounts[7],accounts[6],accounts[0],accounts[4],accounts[0],accounts[3],accounts[6],accounts[2],accounts[0],accounts[9],accounts[3],accounts[5],accounts[5],accounts[1],accounts[0],accounts[4],accounts[1],accounts[0],accounts[5],accounts[0],accounts[7],accounts[1],accounts[9],accounts[5],accounts[2],accounts[9],accounts[7],accounts[7],accounts[9],accounts[3],accounts[5],accounts[0],accounts[0],accounts[1],accounts[8],accounts[5],accounts[1],accounts[4],accounts[3],accounts[4],accounts[8],accounts[7],accounts[9],accounts[1],accounts[6],accounts[3],accounts[6],accounts[3],accounts[9],accounts[2],accounts[4],accounts[2],accounts[5],accounts[5]], [1532892063,97,3,65,6,0,64,1532892062,95,2014223715,1336,10001,1,66,1532892062,27,2014223715,2014223715,1,64,5,255,2,254,1,257,95,1532892062,255,1338,255,26,254,64,2,256,64,64,257,2014223716,10001,3,256,6,6,1336,28,257,1,257,27,1337,6,255,28,1338,95,10000,6,1532892062,0,6,2,1532892064],{from: accounts[0]});
  });
  it('Should fail redeemTokens(address[],uint256[]) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractPartialRedemption.redeemTokens([accounts[1],accounts[3],accounts[5],accounts[0],accounts[0],accounts[7],accounts[5],accounts[2],accounts[5],accounts[0],accounts[7],accounts[6],accounts[0],accounts[4],accounts[0],accounts[3],accounts[6],accounts[2],accounts[0],accounts[9],accounts[3],accounts[5],accounts[5],accounts[1],accounts[0],accounts[4],accounts[1],accounts[0],accounts[5],accounts[0],accounts[7],accounts[1],accounts[9],accounts[5],accounts[2],accounts[9],accounts[7],accounts[7],accounts[9],accounts[3],accounts[5],accounts[0],accounts[0],accounts[1],accounts[8],accounts[5],accounts[1],accounts[4],accounts[3],accounts[4],accounts[8],accounts[7],accounts[9],accounts[1],accounts[6],accounts[3],accounts[6],accounts[3],accounts[9],accounts[2],accounts[4],accounts[2],accounts[5],accounts[5]], [1532892063,97,3,65,6,0,64,1532892062,95,2014223715,1336,10001,1,66,1532892062,27,2014223715,2014223715,1,64,5,255,2,254,1,257,95,1532892062,255,1338,255,26,254,64,2,256,64,64,257,2014223716,10001,3,256,6,6,1336,28,257,1,257,27,1337,6,255,28,1338,95,10000,6,1532892062,0,6,2,1532892064],{from: accounts[9]}),'revert');
  });
  it('Should fail redeemTokens(address[],uint256[]) when NOT comply with: _holders.length == _numberOfTokens.length', async () => {
    let result = await truffleAssert.fails(contractPartialRedemption.redeemTokens([accounts[0],accounts[9],accounts[7],accounts[8],accounts[0],accounts[5],accounts[0],accounts[5],accounts[2],accounts[6],accounts[0],accounts[2],accounts[3],accounts[4],accounts[9],accounts[0],accounts[3],accounts[4],accounts[4],accounts[7],accounts[4],accounts[8],accounts[7],accounts[1],accounts[6],accounts[5],accounts[0],accounts[4],accounts[4],accounts[8],accounts[9],accounts[3],accounts[7],accounts[5],accounts[3],accounts[2],accounts[0],accounts[9],accounts[0],accounts[9],accounts[2],accounts[6],accounts[8],accounts[4],accounts[0],accounts[1],accounts[7],accounts[0],accounts[5],accounts[1],accounts[2],accounts[0],accounts[5],accounts[5],accounts[0],accounts[2],accounts[5],accounts[1],accounts[4],accounts[3],accounts[4],accounts[9],accounts[3],accounts[3],accounts[0]], [1532892063,97,3,65,6,0,64,1532892062,95,2014223715,1336,10001,1,66,1532892062,27,2014223715,2014223715,1,64,5,255,2,254,1,257,95,1532892062,255,1338,255,26,254,64,2,256,64,64,257,2014223716,10001,3,256,6,6,1336,28,257,1,257,27,1337,6,255,28,1338,95,10000,6,1532892062,0,6,2,1532892064],{from: accounts[0]}),'revert');
  });
  it('Should fail redeemTokens(address[],uint256[]) when NOT comply with: _holders.length > 0', async () => {
    let result = await truffleAssert.fails(contractPartialRedemption.redeemTokens([], [1532892063,97,3,65,6,0,64,1532892062,95,2014223715,1336,10001,1,66,1532892062,27,2014223715,2014223715,1,64,5,255,2,254,1,257,95,1532892062,255,1338,255,26,254,64,2,256,64,64,257,2014223716,10001,3,256,6,6,1336,28,257,1,257,27,1337,6,255,28,1338,95,10000,6,1532892062,0,6,2,1532892064],{from: accounts[0]}),'revert');
  });
});
