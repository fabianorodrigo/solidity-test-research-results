...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(2014223715,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[9],256,1336,{from:accounts[7]});
});
