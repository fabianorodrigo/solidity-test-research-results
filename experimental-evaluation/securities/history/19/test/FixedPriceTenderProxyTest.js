...
contract("contractProxyFixedPriceTender",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractProxyFixedPriceTender = await ProxyFixedPriceTender.new(254,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[0],4,3,{from:accounts[7]});
});
