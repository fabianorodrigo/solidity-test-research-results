...
contract("FixedPriceTender",(accounts)=>{
  ...
  it('Should execute updateOfferEndTime(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newOfferEnd>=block.timestamp', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(66,contractRedeemableTokenMock.address,contractRedeemableToken.address,accounts[0],2014223715,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+643,{from:accounts[0]});
    let result = await localFixedPriceTender.updateOfferEndTime((await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+725,{from: accounts[0]});
  });
  ...
  it('Should execute updatePaymentPerSecurity(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newPaymentPerSecurity>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223714,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[0],2,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+53,{from:accounts[0]});
    let result = await localFixedPriceTender.updatePaymentPerSecurity(9999,{from: accounts[0]});
  });
  it('Should fail updatePaymentPerSecurity(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223714,contractRedeemableTokenMock.address,contractPaymentTokenMock.address,accounts[0],2,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+53,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.updatePaymentPerSecurity(9999,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute updateTotalToRepurchase(uint256) WHEN msg.sender==_owner,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_newTotalToRepurchase>=0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223716,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[4],1338,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+392,{from:accounts[0]});
    let result = await localFixedPriceTender.updateTotalToRepurchase(66,{from: accounts[0]});
  });
  it('Should fail updateTotalToRepurchase(uint256) when NOT comply with: msg.sender == _owner', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(2014223716,contractRedeemableToken.address,contractPaymentTokenMock.address,accounts[4],1338,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+392,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.updateTotalToRepurchase(66,{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute optInToTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,paymentReady==true,_numberToTender>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(10001,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[9],64,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+852,{from:accounts[0]});
    await localFixedPriceTender.paymentTokensReady({from:accounts[0]});
    let result = await localFixedPriceTender.optInToTender(97,{from: accounts[0]});
  });
  it('Should fail optInToTender(uint256) when NOT comply with: paymentReady == true', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(10001,contractPaymentTokenMock.address,contractPaymentTokenMock.address,accounts[9],64,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+852,{from:accounts[0]});
    let result = await truffleAssert.fails(localFixedPriceTender.optInToTender(97,{from: accounts[0]}),'revert');
  });
  ...
  it('Should execute optOutOfTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp<offerEndTime,_numberToRemove>0', async () => {
    let localFixedPriceTender = await FixedPriceTender.new(6,contractRedeemableToken.address,contractRedeemableToken.address,accounts[0],29,(await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp+274,{from:accounts[0]});
    let result = await localFixedPriceTender.optOutOfTender(27,{from: accounts[0]});
  });
  ...
  it('Should execute finaliseTender(uint256) WHEN (await web3.eth.getBlock(await web3.eth.getBlockNumber())).timestamp>=offerEndTime,nextTenderToAssess<orderedHolders.length,_batchSize>0', async () => {
    let result = await contractFixedPriceTender.finaliseTender(1337,{from: accounts[0]});
  });
