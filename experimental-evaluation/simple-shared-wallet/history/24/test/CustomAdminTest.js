...
contract("CustomAdmin",(accounts)=>{
  ...
  it('Should execute addAdmin(address) WHEN account!=0x0000000000000000000000000000000000000000,_admins!=true', async () => {
    let result = await contractCustomAdmin.addAdmin(accounts[0],{from: accounts[0]});
  });
  ...
  it('Should execute addManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.addManyAdmins([accounts[7]],{from: accounts[0]});
  });
  ...
  it('Should execute removeManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.removeManyAdmins([accounts[4],accounts[6],accounts[7],accounts[9],accounts[6],accounts[9],accounts[1],accounts[2]],{from: accounts[0]});
  });
