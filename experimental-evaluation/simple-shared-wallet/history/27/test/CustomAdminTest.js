...
contract("CustomAdmin",(accounts)=>{
  ...
  it('Should execute addAdmin(address) WHEN account!=0x0000000000000000000000000000000000000000,_admins!=true', async () => {
    let result = await contractCustomAdmin.addAdmin(accounts[1],{from: accounts[0]});
  });
  ...
  it('Should execute addManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.addManyAdmins([accounts[6],accounts[6],accounts[0],accounts[8],accounts[4]],{from: accounts[0]});
  });
  it('Should execute removeAdmin(address) WHEN account!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractCustomAdmin.removeAdmin(accounts[7],{from: accounts[0]});
  });
  ...
  it('Should execute removeManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.removeManyAdmins([accounts[6],accounts[1],accounts[4],accounts[4],accounts[5],accounts[3],accounts[8],accounts[4],accounts[2]],{from: accounts[0]});
  });
  it('Should execute isAdmin(address)', async () => {
    let result = await contractCustomAdmin.isAdmin(accounts[6],{from: accounts[0]});
  });
});
