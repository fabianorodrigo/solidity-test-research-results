...
contract("CustomAdmin",(accounts)=>{
  ...
  it('Should execute addAdmin(address) WHEN account!=0x0000000000000000000000000000000000000000,_admins!=true', async () => {
    let result = await contractCustomAdmin.addAdmin(accounts[7],{from: accounts[0]});
  });
  ...
  it('Should execute addManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.addManyAdmins([accounts[6],accounts[6],accounts[5],accounts[0],accounts[7]],{from: accounts[0]});
  });
  it('Should execute removeAdmin(address) WHEN account!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractCustomAdmin.removeAdmin(accounts[5],{from: accounts[0]});
  });
  ...
  it('Should execute removeManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.removeManyAdmins([accounts[7],accounts[5],accounts[3],accounts[4],accounts[7],accounts[6],accounts[2]],{from: accounts[0]});
  });
