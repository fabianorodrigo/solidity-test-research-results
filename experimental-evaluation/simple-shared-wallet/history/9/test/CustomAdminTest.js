...
contract("CustomAdmin",(accounts)=>{
  ...
  it('Should execute addManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.addManyAdmins([accounts[8],accounts[1],accounts[1],accounts[6],accounts[3],accounts[4]],{from: accounts[0]});
  });
  ...
  it('Should execute removeManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.removeManyAdmins([accounts[1],accounts[0],accounts[9],accounts[6]],{from: accounts[0]});
  });
