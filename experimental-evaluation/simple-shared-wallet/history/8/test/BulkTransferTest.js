...
contract("BulkTransfer",(accounts)=>{
  ...
  it('Should execute bulkTransfer(address,address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[9],accounts[7],accounts[8],accounts[6],accounts[6],accounts[8],accounts[5],accounts[1],accounts[4],accounts[9]], [95,255,66,64,97,17,1532892064,18,28,255],{from: accounts[0]});
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: _paused != true', async () => {
    ...
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[9],accounts[7],accounts[8],accounts[6],accounts[6],accounts[8],accounts[5],accounts[1],accounts[4],accounts[9]], [95,255,66,64,97,17,1532892064,18,28,255],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[6],accounts[9],accounts[8],accounts[9],accounts[0],accounts[6],accounts[6],accounts[3],accounts[5],accounts[9],accounts[6]], [95,255,66,64,97,17,1532892064,18,28,255],{from: accounts[0]}),'revert');
  });
  it('Should execute bulkTransferEther(address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransferEther([accounts[6],accounts[5],accounts[5]], [1532892064,2014223715,64],{from: accounts[0]});
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: _paused != true', async () => {
    await contractBulkTransfer.pause({from:accounts[0]});
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[6],accounts[5],accounts[5]], [1532892064,2014223715,64],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[4],accounts[0],accounts[6],accounts[6]], [1532892064,2014223715,64],{from: accounts[0]}),'revert');
  });
});
