...
contract("CustomAdmin",(accounts)=>{
  ...
  it('Should execute addAdmin(address) WHEN account!=0x0000000000000000000000000000000000000000,_admins!=true', async () => {
    let result = await contractCustomAdmin.addAdmin(accounts[9],{from: accounts[0]});
  });
  ...
  it('Should execute addManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.addManyAdmins([accounts[1],accounts[4],accounts[0],accounts[9],accounts[6],accounts[2],accounts[5],accounts[6],accounts[4]],{from: accounts[0]});
  });
  ...
  it('Should execute removeManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.removeManyAdmins([accounts[0],accounts[4],accounts[6],accounts[7],accounts[9],accounts[7]],{from: accounts[0]});
  });
  it('Should execute isAdmin(address)', async () => {
    let result = await contractCustomAdmin.isAdmin(accounts[0],{from: accounts[0]});
  });
});
