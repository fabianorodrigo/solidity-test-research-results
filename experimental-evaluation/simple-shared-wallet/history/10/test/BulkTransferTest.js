...
contract("BulkTransfer",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractSimpleToken = await SimpleToken.new({from:accounts[3]});
    if(trace) console.log('SUCESSO: SimpleToken.new({from:accounts[3]}');
  ...
  it('Should execute bulkTransfer(address,address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[0],accounts[7]], [2014223716,65],{from: accounts[0]});
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: _paused != true', async () => {
    ...
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[0],accounts[7]], [2014223716,65],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[1],accounts[4],accounts[0]], [2014223716,65],{from: accounts[0]}),'revert');
  });
  it('Should execute bulkTransferEther(address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransferEther([accounts[4],accounts[1],accounts[6],accounts[5],accounts[5],accounts[6],accounts[1]], [5,64,5,1532892063,2014223716,1532892064,64],{from: accounts[0]});
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: _paused != true', async () => {
    await contractBulkTransfer.pause({from:accounts[0]});
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[4],accounts[1],accounts[6],accounts[5],accounts[5],accounts[6],accounts[1]], [5,64,5,1532892063,2014223716,1532892064,64],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[0],accounts[1],accounts[5],accounts[7],accounts[8],accounts[3],accounts[2],accounts[4]], [5,64,5,1532892063,2014223716,1532892064,64],{from: accounts[0]}),'revert');
  });
});
