...
contract("BulkTransfer",(accounts)=>{
  ...
  it('Should execute bulkTransfer(address,address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[6],accounts[1],accounts[3],accounts[3],accounts[8],accounts[6],accounts[0],accounts[4]], [17,65,29,2014223714,27,18,256,2014223715],{from: accounts[0]});
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: _paused != true', async () => {
    ...
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[6],accounts[1],accounts[3],accounts[3],accounts[8],accounts[6],accounts[0],accounts[4]], [17,65,29,2014223714,27,18,256,2014223715],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[0],accounts[3],accounts[8],accounts[5],accounts[6],accounts[6],accounts[2],accounts[9],accounts[6]], [17,65,29,2014223714,27,18,256,2014223715],{from: accounts[0]}),'revert');
  });
  it('Should execute bulkTransferEther(address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransferEther([accounts[4],accounts[6],accounts[8]], [64,254,0],{from: accounts[0]});
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: _paused != true', async () => {
    await contractBulkTransfer.pause({from:accounts[0]});
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[4],accounts[6],accounts[8]], [64,254,0],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[1],accounts[0],accounts[5],accounts[3]], [64,254,0],{from: accounts[0]}),'revert');
  });
});
