...
contract("CustomAdmin",(accounts)=>{
  ...
  it('Should execute addManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.addManyAdmins([accounts[8],accounts[6],accounts[8],accounts[9],accounts[5]],{from: accounts[0]});
  });
  ...
  it('Should execute removeManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.removeManyAdmins([accounts[8],accounts[4],accounts[1],accounts[7],accounts[0],accounts[6],accounts[6],accounts[0]],{from: accounts[0]});
  });
