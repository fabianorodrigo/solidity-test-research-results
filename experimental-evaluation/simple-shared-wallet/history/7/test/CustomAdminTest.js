...
contract("CustomAdmin",(accounts)=>{
  ...
  it('Should execute addManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.addManyAdmins([accounts[3],accounts[4],accounts[4],accounts[4]],{from: accounts[0]});
  });
  it('Should execute removeAdmin(address) WHEN account!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractCustomAdmin.removeAdmin(accounts[8],{from: accounts[0]});
  });
  ...
  it('Should execute removeManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.removeManyAdmins([accounts[3],accounts[0],accounts[3],accounts[7],accounts[2],accounts[0],accounts[8],accounts[8],accounts[9]],{from: accounts[0]});
  });
