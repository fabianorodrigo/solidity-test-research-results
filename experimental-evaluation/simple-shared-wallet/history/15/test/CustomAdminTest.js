...
contract("CustomAdmin",(accounts)=>{
  ...
  it('Should execute addManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.addManyAdmins([accounts[5],accounts[7],accounts[8],accounts[0],accounts[7],accounts[2],accounts[3],accounts[2],accounts[4]],{from: accounts[0]});
  });
  ...
  it('Should execute removeManyAdmins(address[])', async () => {
    let result = await contractCustomAdmin.removeManyAdmins([accounts[9],accounts[2],accounts[4]],{from: accounts[0]});
  });
