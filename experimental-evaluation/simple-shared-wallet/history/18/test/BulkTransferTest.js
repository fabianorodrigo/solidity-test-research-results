...
contract("BulkTransfer",(accounts)=>{
  ...
  it('Should execute bulkTransfer(address,address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[5],accounts[1],accounts[2],accounts[4],accounts[4],accounts[4],accounts[7],accounts[6],accounts[4]], [4,95,1532892064,3,0,4,26,27,96],{from: accounts[0]});
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: _paused != true', async () => {
    ...
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[5],accounts[1],accounts[2],accounts[4],accounts[4],accounts[4],accounts[7],accounts[6],accounts[4]], [4,95,1532892064,3,0,4,26,27,96],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[1],accounts[6],accounts[3],accounts[8],accounts[2],accounts[5],accounts[0],accounts[1],accounts[9],accounts[1]], [4,95,1532892064,3,0,4,26,27,96],{from: accounts[0]}),'revert');
  });
  it('Should execute bulkTransferEther(address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransferEther([accounts[1],accounts[5],accounts[1],accounts[2],accounts[4],accounts[3],accounts[5]], [65,28,2014223714,64,95,66,5],{from: accounts[0]});
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: _paused != true', async () => {
    await contractBulkTransfer.pause({from:accounts[0]});
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[1],accounts[5],accounts[1],accounts[2],accounts[4],accounts[3],accounts[5]], [65,28,2014223714,64,95,66,5],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[2],accounts[0],accounts[5],accounts[6],accounts[4],accounts[2],accounts[0],accounts[7]], [65,28,2014223714,64,95,66,5],{from: accounts[0]}),'revert');
  });
});
