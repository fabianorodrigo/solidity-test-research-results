...
contract("BulkTransfer",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractSimpleToken = await SimpleToken.new({from:accounts[4]});
    if(trace) console.log('SUCESSO: SimpleToken.new({from:accounts[4]}');
  ...
  it('Should execute bulkTransfer(address,address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[1],accounts[4],accounts[2],accounts[8],accounts[5],accounts[9]], [66,2014223714,1,27,2014223716,2014223715],{from: accounts[0]});
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: _paused != true', async () => {
    ...
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[1],accounts[4],accounts[2],accounts[8],accounts[5],accounts[9]], [66,2014223714,1,27,2014223716,2014223715],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransfer(address,address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransfer(contractSimpleToken.address, [accounts[3],accounts[8],accounts[5],accounts[3],accounts[5],accounts[7],accounts[2]], [66,2014223714,1,27,2014223716,2014223715],{from: accounts[0]}),'revert');
  });
  it('Should execute bulkTransferEther(address[],uint256[]) WHEN _paused!=true,destinations.length==amounts.length', async () => {
    let result = await contractBulkTransfer.bulkTransferEther([accounts[6],accounts[5],accounts[2],accounts[3],accounts[5],accounts[2],accounts[5],accounts[1]], [1,18,255,18,66,4,19,2014223715],{from: accounts[0]});
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: _paused != true', async () => {
    await contractBulkTransfer.pause({from:accounts[0]});
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[6],accounts[5],accounts[2],accounts[3],accounts[5],accounts[2],accounts[5],accounts[1]], [1,18,255,18,66,4,19,2014223715],{from: accounts[0]}),'revert');
  });
  it('Should fail bulkTransferEther(address[],uint256[]) when NOT comply with: destinations.length == amounts.length', async () => {
    let result = await truffleAssert.fails(contractBulkTransfer.bulkTransferEther([accounts[6],accounts[5],accounts[3],accounts[3],accounts[8],accounts[9],accounts[3],accounts[7],accounts[7]], [1,18,255,18,66,4,19,2014223715],{from: accounts[0]}),'revert');
  });
});
