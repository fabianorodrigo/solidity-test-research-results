...
contract("ExternalContract",(accounts)=>{
  let trace = false;
  ...
  it('Should execute updateValue(uint256)', async () => {
    let result = await contractExternalContract.updateValue(1532892064,{from: accounts[0]});
  });
});
