...
contract("SimpleCoin",(accounts)=>{
  ...
  it('Should execute allowance(address,address)', async () => {
    let result = await contractSimpleCoin.allowance(accounts[6], accounts[8],{from: accounts[0]});
  });
  ...
  it('Should execute transfer(address,uint256) WHEN balances>=_value', async () => {
    let result = await contractSimpleCoin.transfer(accounts[5], 1000001,{from: accounts[0]});
  });
  it('Should execute transferFrom(address,address,uint256) WHEN balances>=_value,remaining>=_value', async () => {
    let result = await contractSimpleCoin.transferFrom(accounts[9], accounts[7], 0,{from: accounts[0]});
  });
  ...
  it('Should execute declineOwnership() WHEN msg.sender==newOwner', async () => {
    ...
    let result = await contractSimpleCoin.declineOwnership({from: accounts[8]});
  });
