...
contract("SimpleCoin",(accounts)=>{
  ...
  it('Should execute allowance(address,address)', async () => {
    let result = await contractSimpleCoin.allowance(accounts[3], accounts[3],{from: accounts[0]});
  });
  ...
  it('Should execute transfer(address,uint256) WHEN balances>=_value', async () => {
    let result = await contractSimpleCoin.transfer(accounts[4], 1,{from: accounts[0]});
  });
  it('Should execute transferFrom(address,address,uint256) WHEN balances>=_value,remaining>=_value', async () => {
    let result = await contractSimpleCoin.transferFrom(accounts[5], accounts[3], 1000001,{from: accounts[0]});
  });
  it('Should execute approve(address,uint256)', async () => {
    let result = await contractSimpleCoin.approve(accounts[0], 999999,{from: accounts[0]});
  });
  ...
  it('Should execute acceptOwnership() WHEN msg.sender==newOwner', async () => {
    ...
    let result = await contractSimpleCoin.acceptOwnership({from: accounts[2]});
  });
  ...
  it('Should execute declineOwnership() WHEN msg.sender==newOwner', async () => {
    ...
    let result = await contractSimpleCoin.declineOwnership({from: accounts[3]});
  });
