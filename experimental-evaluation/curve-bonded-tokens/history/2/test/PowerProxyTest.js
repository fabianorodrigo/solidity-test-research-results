...
contract("contractProxyPower",(accounts)=>{
  ...
  it('Should execute testpower(uint256,uint256,uint32,uint32) WHEN _baseN<MAX_NUM,_baseN>=_baseD', async () => {
    let result = await contractProxyPower.testpower(89, 73, 123, 106,{from: accounts[0]});
  });
  it('Should fail testpower(uint256,uint256,uint32,uint32) when NOT comply with: _baseN < MAX_NUM', async () => {
    let result = await truffleAssert.fails(contractProxyPower.testpower(new web3.utils.BN('6.80564733841877e+38'), 73, 123, 106,{from: accounts[0]}),'revert');
  });
  it('Should fail testpower(uint256,uint256,uint32,uint32) when NOT comply with: _baseN >= _baseD', async () => {
    let result = await truffleAssert.fails(contractProxyPower.testpower(72, 73, 123, 106,{from: accounts[0]}),'revert');
  });
  it('Should execute testgeneralLog(uint256) WHEN LN2_DENOMINATOR>0', async () => {
    let result = await contractProxyPower.testgeneralLog(1532892062,{from: accounts[0]});
  });
  ...
  it('Should execute testfindPositionInMaxExpArray(uint256) WHEN maxExpArray<_x', async () => {
    let result = await contractProxyPower.testfindPositionInMaxExpArray(255,{from: accounts[0]});
  });
  it('Should execute testfindPositionInMaxExpArray(uint256) WHEN maxExpArray>=_x', async () => {
    let result = await contractProxyPower.testfindPositionInMaxExpArray(110,{from: accounts[0]});
  });
  it('Should execute testfindPositionInMaxExpArray(uint256) WHEN maxExpArray<_x,maxExpArray<_x', async () => {
    let result = await contractProxyPower.testfindPositionInMaxExpArray(39,{from: accounts[0]});
  });
  it('Should execute testgeneralExp(uint256,uint8)', async () => {
    let result = await contractProxyPower.testgeneralExp(50, 81,{from: accounts[0]});
  });
  ...
  it('Should execute testoptimalLog(uint256) WHEN x<0x910b022db7ae67ce76b441c27035c6a1', async () => {
    let result = await contractProxyPower.testoptimalLog(46,{from: accounts[0]});
  });
  ...
  it('Should execute testoptimalLog(uint256) WHEN x<0x84102b00893f64c705e841d5d4064bd3', async () => {
    let result = await contractProxyPower.testoptimalLog(49,{from: accounts[0]});
  });
  ...
  it('Should execute testoptimalExp(uint256)', async () => {
    let result = await contractProxyPower.testoptimalExp(51,{from: accounts[0]});
  });
});
