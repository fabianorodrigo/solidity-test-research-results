...
contract("ERC20BondingToken",(accounts)=>{
  ...
  it('Should execute initialize(ERC20,uint256,uint256,uint32,uint256) WHEN initialized!=true', async () => {
    let result = await contractERC20BondingToken.methods["initialize(address,uint256,uint256,uint32,uint256)"](contractTestEthBondingToken.address, 32736, 125, 57, 1000001,{from: accounts[0]});
  });
  it('Should execute poolBalance()', async () => {
    let result = await contractERC20BondingToken.poolBalance({from: accounts[0]});
  });
  it('Should execute calculateCurvedMintReturn(uint256)', async () => {
    let result = await contractERC20BondingToken.calculateCurvedMintReturn(129,{from: accounts[0]});
  });
  it('Should execute calculateCurvedBurnReturn(uint256)', async () => {
    let result = await contractERC20BondingToken.calculateCurvedBurnReturn(1532892064,{from: accounts[0]});
  });
});
