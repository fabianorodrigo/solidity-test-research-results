...
contract("EthBondingToken",(accounts)=>{
  ...
  it('Should execute initialize(uint256,uint32,uint256) WHEN initialized!=true', async () => {
    let result = await contractEthBondingToken.initialize(255, 75, 41,{from: accounts[0]});
  });
  ...
  it('Should execute calculateCurvedMintReturn(uint256)', async () => {
    let result = await contractEthBondingToken.calculateCurvedMintReturn(29,{from: accounts[0]});
  });
  it('Should execute calculateCurvedBurnReturn(uint256)', async () => {
    let result = await contractEthBondingToken.calculateCurvedBurnReturn(52,{from: accounts[0]});
  });
});
