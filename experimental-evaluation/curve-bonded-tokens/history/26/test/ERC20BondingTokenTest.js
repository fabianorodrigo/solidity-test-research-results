...
contract("ERC20BondingToken",(accounts)=>{
  ...
  it('Should execute initialize(ERC20,uint256,uint256,uint32,uint256) WHEN initialized!=true', async () => {
    let result = await contractERC20BondingToken.methods["initialize(address,uint256,uint256,uint32,uint256)"](contractTestERC20BondingToken.address, 4038714810, 78, 92, 0,{from: accounts[0]});
  });
  ...
  it('Should execute calculateCurvedMintReturn(uint256)', async () => {
    let result = await contractERC20BondingToken.calculateCurvedMintReturn(61,{from: accounts[0]});
  });
  it('Should execute calculateCurvedBurnReturn(uint256)', async () => {
    let result = await contractERC20BondingToken.calculateCurvedBurnReturn(112,{from: accounts[0]});
  });
});
