...
contract("EthBondingToken",(accounts)=>{
  ...
  it('Should execute initialize(uint256,uint32,uint256) WHEN initialized!=true', async () => {
    let result = await contractEthBondingToken.initialize(56, 58, 85,{from: accounts[0]});
  });
  ...
  it('Should execute calculateCurvedMintReturn(uint256)', async () => {
    let result = await contractEthBondingToken.calculateCurvedMintReturn(77,{from: accounts[0]});
  });
  it('Should execute calculateCurvedBurnReturn(uint256)', async () => {
    let result = await contractEthBondingToken.calculateCurvedBurnReturn(86,{from: accounts[0]});
  });
});
