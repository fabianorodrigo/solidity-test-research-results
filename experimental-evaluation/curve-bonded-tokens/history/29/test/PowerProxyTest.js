...
contract("contractProxyPower",(accounts)=>{
  ...
  it('Should execute testpower(uint256,uint256,uint32,uint32) WHEN _baseN<MAX_NUM,_baseN>=_baseD', async () => {
    let result = await contractProxyPower.testpower(40, 34, 1000000, 102,{from: accounts[0]});
  });
  it('Should fail testpower(uint256,uint256,uint32,uint32) when NOT comply with: _baseN < MAX_NUM', async () => {
    let result = await truffleAssert.fails(contractProxyPower.testpower(new web3.utils.BN('6.80564733841877e+38'), 34, 1000000, 102,{from: accounts[0]}),'revert');
  });
  it('Should fail testpower(uint256,uint256,uint32,uint32) when NOT comply with: _baseN >= _baseD', async () => {
    let result = await truffleAssert.fails(contractProxyPower.testpower(33, 34, 1000000, 102,{from: accounts[0]}),'revert');
  });
  it('Should execute testgeneralLog(uint256) WHEN LN2_DENOMINATOR>0', async () => {
    let result = await contractProxyPower.testgeneralLog(100,{from: accounts[0]});
  });
  it('Should execute testfloorLog2(uint256)', async () => {
    let result = await contractProxyPower.testfloorLog2(88,{from: accounts[0]});
  });
  ...
  it('Should execute testfindPositionInMaxExpArray(uint256) WHEN maxExpArray<_x', async () => {
    let result = await contractProxyPower.testfindPositionInMaxExpArray(126,{from: accounts[0]});
  });
  it('Should execute testfindPositionInMaxExpArray(uint256) WHEN maxExpArray>=_x', async () => {
  ...
  it('Should execute testgeneralExp(uint256,uint8)', async () => {
    let result = await contractProxyPower.testgeneralExp(4038714811, 67,{from: accounts[0]});
  });
  ...
  it('Should execute testoptimalLog(uint256) WHEN x<0x8204055aaef1c8bd5c3259f4822735a2', async () => {
    let result = await contractProxyPower.testoptimalLog(103,{from: accounts[0]});
  });
  ...
  it('Should execute testoptimalLog(uint256) WHEN x<0x810100ab00222d861931c15e39b44e99', async () => {
    let result = await contractProxyPower.testoptimalLog(91,{from: accounts[0]});
  });
  ...
  it('Should execute testoptimalExp(uint256)', async () => {
    let result = await contractProxyPower.testoptimalExp(59,{from: accounts[0]});
  });
});
