...
contract("EthBondingToken",(accounts)=>{
  ...
  it('Should execute initialize(uint256,uint32,uint256) WHEN initialized!=true', async () => {
    let result = await contractEthBondingToken.initialize(126, 4038714810, 100,{from: accounts[0]});
  });
  ...
  it('Should execute calculateCurvedMintReturn(uint256)', async () => {
    let result = await contractEthBondingToken.calculateCurvedMintReturn(82,{from: accounts[0]});
  });
  it('Should execute calculateCurvedBurnReturn(uint256)', async () => {
    let result = await contractEthBondingToken.calculateCurvedBurnReturn(51,{from: accounts[0]});
  });
});
