...
contract("ERC20BondingToken",(accounts)=>{
  ...
  it('Should execute initialize(ERC20,uint256,uint256,uint32,uint256) WHEN initialized!=true', async () => {
    let result = await contractERC20BondingToken.methods["initialize(address,uint256,uint256,uint32,uint256)"](contractEthBondingToken.address, 120, 82, 62, 982080,{from: accounts[0]});
  });
  ...
  it('Should execute calculateCurvedMintReturn(uint256)', async () => {
    let result = await contractERC20BondingToken.calculateCurvedMintReturn(32737,{from: accounts[0]});
  });
  it('Should execute calculateCurvedBurnReturn(uint256)', async () => {
    let result = await contractERC20BondingToken.calculateCurvedBurnReturn(67,{from: accounts[0]});
  });
});
