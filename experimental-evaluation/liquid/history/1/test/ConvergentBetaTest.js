...
contract("ConvergentBeta",(accounts)=>{
  ...
  it('Should execute initialize(address,address) WHEN initialized!=true', async () => {
    let result = await contractConvergentBeta.methods["initialize(address,address)"](accounts[2], accounts[1],{from: accounts[0]});
  });
  it('Should execute setBaseAccount(address) WHEN msg.sender==_owner,_newBaseAccount!=0x0000000000000000000000000000000000000000', async () => {
    await contractConvergentBeta.methods["initialize(address,address)"](accounts[8],accounts[8],{from:accounts[0]});
  ...
  it('Should execute createAccount(address,uint256,uint256,uint256,uint256,uint256,uint256,bytes32,string,string)', async () => {
    let result = await contractConvergentBeta.createAccount(accounts[2], 64, 2014223715, 65, 1532892063, 26, 1338, [28,2,189,27,124,77,137,174,168,130,125,44,251,187,116,16,9,181,143,47,41,160,166,150,41,69,247,166,151,247,98,191], "IsLibrary", "\x19Ethereum Signed Message:\n32",{from: accounts[0]});
  });
