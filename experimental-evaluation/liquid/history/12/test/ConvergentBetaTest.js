...
contract("ConvergentBeta",(accounts)=>{
  ...
  it('Should execute initialize(address,address) WHEN initialized!=true', async () => {
    let result = await contractConvergentBeta.methods["initialize(address,address)"](accounts[8], accounts[1],{from: accounts[0]});
  });
  ...
  it('Should execute createAccount(address,uint256,uint256,uint256,uint256,uint256,uint256,bytes32,string,string)', async () => {
    let result = await contractConvergentBeta.createAccount(accounts[2], 10001, 1, 1336, 2014223715, 4038714810, 1, [186,55,121,134,86,44,195,121,217,151,134,2,123,125,78,64,91,40,127,85,50,150,189,109,151,221,107,14,209,210,185,144], "bouncer", "minter",{from: accounts[0]});
  });
