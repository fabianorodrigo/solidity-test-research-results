...
contract("ConvergentBeta",(accounts)=>{
  ...
  it('Should execute initialize(address,address) WHEN initialized!=true', async () => {
    let result = await contractConvergentBeta.methods["initialize(address,address)"](accounts[4], accounts[1],{from: accounts[0]});
  });
  ...
  it('Should execute createAccount(address,uint256,uint256,uint256,uint256,uint256,uint256,bytes32,string,string)', async () => {
    let result = await contractConvergentBeta.createAccount(accounts[7], 65, 4, 1336, 10000, 96, 18, [172,198,158,128,228,94,62,136,123,100,139,36,194,235,161,235,230,53,154,49,70,16,17,66,1,200,176,167,132,109,254,147], "PayableExample", "UsesExample",{from: accounts[0]});
  });
