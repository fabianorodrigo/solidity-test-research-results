...
contract("ConvergentBeta",(accounts)=>{
  ...
  it('Should execute initialize(address,address) WHEN initialized!=true', async () => {
    let result = await contractConvergentBeta.methods["initialize(address,address)"](accounts[4], accounts[5],{from: accounts[0]});
  });
  it('Should execute setBaseAccount(address) WHEN msg.sender==_owner,_newBaseAccount!=0x0000000000000000000000000000000000000000', async () => {
    await contractConvergentBeta.methods["initialize(address,address)"](accounts[8],accounts[1],{from:accounts[0]});
    let result = await contractConvergentBeta.setBaseAccount(accounts[3],{from: accounts[0]});
  });
  ...
  it('Should execute createAccount(address,uint256,uint256,uint256,uint256,uint256,uint256,bytes32,string,string)', async () => {
    let result = await contractConvergentBeta.createAccount(accounts[7], 64, 65, 2014223715, 256, 17, 1336, [20,36,162,169,151,207,9,30,33,84,157,36,116,200,102,137,11,170,88,177,140,132,96,59,210,201,84,234,238,180,168,136], "PayableExample", "whitelist",{from: accounts[0]});
  });
