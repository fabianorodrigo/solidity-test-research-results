...
contract("ConvergentBeta",(accounts)=>{
  ...
  it('Should execute initialize(address,address) WHEN initialized!=true', async () => {
    let result = await contractConvergentBeta.methods["initialize(address,address)"](accounts[7], accounts[0],{from: accounts[0]});
  });
  it('Should execute setBaseAccount(address) WHEN msg.sender==_owner,_newBaseAccount!=0x0000000000000000000000000000000000000000', async () => {
    ...
    let result = await contractConvergentBeta.setBaseAccount(accounts[6],{from: accounts[0]});
  });
  ...
  it('Should execute createAccount(address,uint256,uint256,uint256,uint256,uint256,uint256,bytes32,string,string)', async () => {
    let result = await contractConvergentBeta.createAccount(accounts[7], 1337, 9, 95, 1532892064, 1338, 65, [198,194,43,169,100,41,64,109,108,139,32,246,17,27,112,72,227,248,232,62,9,4,206,185,109,135,163,67,68,247,83,96], "qnvjzn", "superuser",{from: accounts[0]});
  });
