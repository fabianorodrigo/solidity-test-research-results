...
contract("ERC721Metadata",(accounts)=>{
  ...
  it('Should execute getName()', async () => {
    let result = await contractERC721Metadata.getName({from: accounts[0]});
  });
  it('Should execute getSymbol()', async () => {
    let result = await contractERC721Metadata.getSymbol({from: accounts[0]});
  });
  it('Should execute getBaseTokenURI()', async () => {
    let result = await contractERC721Metadata.getBaseTokenURI({from: accounts[0]});
  });
  it('Should execute tokenURI(uint256)', async () => {
    let result = await contractERC721Metadata.tokenURI(1532892063,{from: accounts[0]});
  });
});
