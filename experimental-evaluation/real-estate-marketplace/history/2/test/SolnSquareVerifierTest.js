...
contract("SolnSquareVerifier",(accounts)=>{
  ...
  it('Should execute addSolution(uint256,address,uint[2],uint[2][2],uint[2],uint[2]) WHEN solutionKeyToSubmissionStatus!=true', async () => {
    let result = await contractSolnSquareVerifier.addSolution(162, accounts[1], [1024,71], [[1,19],[96,63]], [17,255], [127,55],{from: accounts[0]});
  });
  it('Should execute mint(address,uint256)', async () => {
    let result = await contractSolnSquareVerifier.mint(accounts[3], 1532892062,{from: accounts[0]});
  });
});
