...
contract("contractProxyPairing",(accounts)=>{
  ...
  it('Should execute testnegate(Pairing.G1Point) WHEN p.Y!=0', async () => {
    let result = await contractProxyPairing.testnegate({"X": 160,"Y": 97},{from: accounts[0]});
  });
  it('Should execute testaddition0(Pairing.G1Point,Pairing.G1Point)', async () => {
    let result = await contractProxyPairing.testaddition0({"X": 96,"Y": 61}, {"X": 200000,"Y": 48},{from: accounts[0]});
  });
  it('Should execute testaddition1(Pairing.G2Point,Pairing.G2Point)', async () => {
    let result = await contractProxyPairing.testaddition1({"X": [27,31],"Y": [2014223714,59]}, {"X": [2014223716,54],"Y": [59,1532892062]},{from: accounts[0]});
  });
  it('Should execute testscalar_mul(Pairing.G1Point,uint)', async () => {
    let result = await contractProxyPairing.testscalar_mul({"X": 17,"Y": 2}, 1532892063,{from: accounts[0]});
  });
  it('Should execute testpairing(Pairing.G1Point[],Pairing.G2Point[]) WHEN p1.length==p2.length', async () => {
    let result = await contractProxyPairing.testpairing([{"X": 6,"Y": 65},{"X": 20,"Y": 32},{"X": 26,"Y": 98},{"X": 0,"Y": 26},{"X": 96,"Y": 21},{"X": 161,"Y": 101},{"X": 27,"Y": 27},{"X": 129,"Y": 16},{"X": 18,"Y": 49},{"X": 27,"Y": 16}], [{"X": [3,200000],"Y": [96,87]},{"X": [11,5],"Y": [25,1024]},{"X": [28,98],"Y": [22,129]},{"X": [96,63],"Y": [1,257]},{"X": [20,16],"Y": [55,18]},{"X": [60,31],"Y": [1024,1532892064]},{"X": [102,257],"Y": [21,95]},{"X": [1024,9],"Y": [2014223714,255]},{"X": [46,31],"Y": [6,86]},{"X": [61,160],"Y": [26,45]}],{from: accounts[0]});
  });
  it('Should fail testpairing(Pairing.G1Point[],Pairing.G2Point[]) when NOT comply with: p1.length == p2.length', async () => {
    let result = await truffleAssert.fails(contractProxyPairing.testpairing([{"X": 0,"Y": 58},{"X": 1024,"Y": 55},{"X": 1532892063,"Y": 10},{"X": 55,"Y": 1532892063},{"X": 257,"Y": 32},{"X": 1023,"Y": 0},{"X": 26,"Y": 86},{"X": 27,"Y": 65},{"X": 29,"Y": 20},{"X": 200001,"Y": 1532892063},{"X": 10,"Y": 59}], [{"X": [3,200000],"Y": [96,87]},{"X": [11,5],"Y": [25,1024]},{"X": [28,98],"Y": [22,129]},{"X": [96,63],"Y": [1,257]},{"X": [20,16],"Y": [55,18]},{"X": [60,31],"Y": [1024,1532892064]},{"X": [102,257],"Y": [21,95]},{"X": [1024,9],"Y": [2014223714,255]},{"X": [46,31],"Y": [6,86]},{"X": [61,160],"Y": [26,45]}],{from: accounts[0]}),'revert');
  });
  it('Should execute testpairingProd2(Pairing.G1Point,Pairing.G2Point,Pairing.G1Point,Pairing.G2Point)', async () => {
    let result = await contractProxyPairing.testpairingProd2({"X": 55,"Y": 58}, {"X": [22,19],"Y": [257,15]}, {"X": 7,"Y": 127}, {"X": [31,22],"Y": [1025,23]},{from: accounts[0]});
  });
  it('Should execute testpairingProd3(Pairing.G1Point,Pairing.G2Point,Pairing.G1Point,Pairing.G2Point,Pairing.G1Point,Pairing.G2Point)', async () => {
    let result = await contractProxyPairing.testpairingProd3({"X": 4,"Y": 161}, {"X": [10,1023],"Y": [30,65]}, {"X": 30,"Y": 87}, {"X": [8,20],"Y": [88,2014223714]}, {"X": 24,"Y": 19}, {"X": [66,25],"Y": [87,9]},{from: accounts[0]});
  });
});
