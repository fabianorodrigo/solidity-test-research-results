...
contract("usingOraclize",(accounts)=>{
  ...
  it('Should execute __callback(bytes32,string)', async () => {
    let result = await contractusingOraclize.methods["__callback(bytes32,string)"]([236,108,44,72,161,37,145,85,226,2,240,91,39,96,128,88,149,47,155,170,92,152,68,125,227,212,164,185,130,217,110,143], "L",{from: accounts[0]});
  });
  it('Should execute __callback(bytes32,string,bytes)', async () => {
    let result = await contractusingOraclize.methods["__callback(bytes32,string,bytes)"]([163,7,240,43,183,170,67,125,80,138,211,175,90,210,51,18,76,12,90,29,1,91,198,248,175,178,26,177,149,14,196,59], "6rrpb", [249,138,105,245,98,248,135,202,37,31,10,121,206,173,60,151,233,85,12,254,226,185,171,36,88,233,233,49,213,97,236,219],{from: accounts[0]});
  });
});
