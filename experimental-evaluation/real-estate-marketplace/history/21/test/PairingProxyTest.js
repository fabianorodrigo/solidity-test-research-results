...
contract("contractProxyPairing",(accounts)=>{
  ...
  it('Should execute testnegate(Pairing.G1Point) WHEN p.Y!=0', async () => {
    let result = await contractProxyPairing.testnegate({"X": 2014223716,"Y": 16},{from: accounts[0]});
  });
  it('Should execute testaddition0(Pairing.G1Point,Pairing.G1Point)', async () => {
    let result = await contractProxyPairing.testaddition0({"X": 47,"Y": 16}, {"X": 65,"Y": 97},{from: accounts[0]});
  });
  it('Should execute testaddition1(Pairing.G2Point,Pairing.G2Point)', async () => {
    let result = await contractProxyPairing.testaddition1({"X": [2014223714,21],"Y": [17,87]}, {"X": [19,57],"Y": [95,127]},{from: accounts[0]});
  });
  it('Should execute testscalar_mul(Pairing.G1Point,uint)', async () => {
    let result = await contractProxyPairing.testscalar_mul({"X": 54,"Y": 1532892064}, 98,{from: accounts[0]});
  });
  it('Should execute testpairing(Pairing.G1Point[],Pairing.G2Point[]) WHEN p1.length==p2.length', async () => {
    let result = await contractProxyPairing.testpairing([{"X": 103,"Y": 30},{"X": 3,"Y": 21},{"X": 60,"Y": 3},{"X": 17,"Y": 54},{"X": 11,"Y": 49},{"X": 2,"Y": 49},{"X": 57,"Y": 59},{"X": 58,"Y": 162},{"X": 49,"Y": 32}], [{"X": [18,2014223716],"Y": [18,102]},{"X": [29,162],"Y": [33,3]},{"X": [45,19],"Y": [95,86]},{"X": [47,21],"Y": [2014223716,64]},{"X": [33,95],"Y": [45,1024]},{"X": [103,2014223714],"Y": [56,45]},{"X": [23,47],"Y": [20,29]},{"X": [30,64],"Y": [257,29]},{"X": [46,162],"Y": [2014223716,54]}],{from: accounts[0]});
  });
  it('Should fail testpairing(Pairing.G1Point[],Pairing.G2Point[]) when NOT comply with: p1.length == p2.length', async () => {
    let result = await truffleAssert.fails(contractProxyPairing.testpairing([{"X": 66,"Y": 21},{"X": 33,"Y": 71},{"X": 1532892064,"Y": 1532892062},{"X": 48,"Y": 27},{"X": 47,"Y": 5},{"X": 70,"Y": 15},{"X": 24,"Y": 2014223714},{"X": 255,"Y": 45},{"X": 200001,"Y": 64},{"X": 95,"Y": 2014223714}], [{"X": [18,2014223716],"Y": [18,102]},{"X": [29,162],"Y": [33,3]},{"X": [45,19],"Y": [95,86]},{"X": [47,21],"Y": [2014223716,64]},{"X": [33,95],"Y": [45,1024]},{"X": [103,2014223714],"Y": [56,45]},{"X": [23,47],"Y": [20,29]},{"X": [30,64],"Y": [257,29]},{"X": [46,162],"Y": [2014223716,54]}],{from: accounts[0]}),'revert');
  });
  it('Should execute testpairingProd2(Pairing.G1Point,Pairing.G2Point,Pairing.G1Point,Pairing.G2Point)', async () => {
    let result = await contractProxyPairing.testpairingProd2({"X": 27,"Y": 69}, {"X": [61,69],"Y": [97,70]}, {"X": 95,"Y": 23}, {"X": [20,11],"Y": [46,61]},{from: accounts[0]});
  });
  it('Should execute testpairingProd3(Pairing.G1Point,Pairing.G2Point,Pairing.G1Point,Pairing.G2Point,Pairing.G1Point,Pairing.G2Point)', async () => {
    let result = await contractProxyPairing.testpairingProd3({"X": 59,"Y": 5}, {"X": [66,127],"Y": [46,162]}, {"X": 31,"Y": 59}, {"X": [60,45],"Y": [21,1]}, {"X": 63,"Y": 28}, {"X": [19,2014223715],"Y": [69,1023]},{from: accounts[0]});
  });
});
