...
contract("SolnSquareVerifier",(accounts)=>{
  ...
  it('Should execute addSolution(uint256,address,uint[2],uint[2][2],uint[2],uint[2]) WHEN solutionKeyToSubmissionStatus!=true', async () => {
    let result = await contractSolnSquareVerifier.addSolution(1532892062, accounts[1], [97,86], [[161,56],[63,2014223716]], [101,46], [128,1],{from: accounts[0]});
  });
  it('Should execute mint(address,uint256)', async () => {
    let result = await contractSolnSquareVerifier.mint(accounts[1], 7,{from: accounts[0]});
  });
});
