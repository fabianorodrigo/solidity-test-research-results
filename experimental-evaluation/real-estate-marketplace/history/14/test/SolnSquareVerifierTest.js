...
contract("SolnSquareVerifier",(accounts)=>{
  ...
  it('Should execute addSolution(uint256,address,uint[2],uint[2][2],uint[2],uint[2]) WHEN solutionKeyToSubmissionStatus!=true', async () => {
    let result = await contractSolnSquareVerifier.addSolution(60, accounts[4], [1532892063,200001], [[48,127],[2014223716,64]], [0,54], [11,87],{from: accounts[0]});
  });
  it('Should execute mint(address,uint256)', async () => {
    let result = await contractSolnSquareVerifier.mint(accounts[9], 26,{from: accounts[0]});
  });
});
