...
contract("SolnSquareVerifier",(accounts)=>{
  ...
  it('Should execute addSolution(uint256,address,uint[2],uint[2][2],uint[2],uint[2]) WHEN solutionKeyToSubmissionStatus!=true', async () => {
    let result = await contractSolnSquareVerifier.addSolution(54, accounts[3], [200001,9], [[97,16],[22,19]], [98,98], [161,1532892063],{from: accounts[0]});
  });
  it('Should execute mint(address,uint256)', async () => {
    let result = await contractSolnSquareVerifier.mint(accounts[2], 32,{from: accounts[0]});
  });
});
