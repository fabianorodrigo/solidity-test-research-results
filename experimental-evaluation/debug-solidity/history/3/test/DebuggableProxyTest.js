...
contract("contractProxyDebuggable",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractDebugCounter = await DebugCounter.new("7ga6o",{from:accounts[0]});
    if(trace) console.log('SUCESSO: DebugCounter.new("7ga6o",{from:accounts[0]}');
  ...
  it('Should execute testdebug0(string)', async () => {
    let result = await contractProxyDebuggable.testdebug0("jqgg08",{from: accounts[0]});
  });
  it('Should execute testdebug1(bytes32)', async () => {
    let result = await contractProxyDebuggable.testdebug1([134,93,53,81,8,231,112,63,251,134,31,76,87,172,123,1,232,9,194,203,27,177,30,6,18,235,241,197,24,97,132,255],{from: accounts[0]});
  });
  it('Should execute testdebug2(uint256)', async () => {
    let result = await contractProxyDebuggable.testdebug2(3,{from: accounts[0]});
  });
  it('Should execute testdebug3(address)', async () => {
    let result = await contractProxyDebuggable.testdebug3(accounts[6],{from: accounts[0]});
  });
  ...
  it('Should execute testdebugRevert1(string)', async () => {
    let result = await contractProxyDebuggable.testdebugRevert1("7ga6o",{from: accounts[0]});
  });
