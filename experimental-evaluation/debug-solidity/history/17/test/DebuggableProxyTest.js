...
contract("contractProxyDebuggable",(accounts)=>{
  ...
  it('Should execute testdebug0(string)', async () => {
    let result = await contractProxyDebuggable.testdebug0("geweu",{from: accounts[0]});
  });
  it('Should execute testdebug1(bytes32)', async () => {
    let result = await contractProxyDebuggable.testdebug1([31,26,43,139,63,129,234,243,57,3,220,69,130,188,8,171,146,41,117,1,188,29,205,99,183,150,247,16,245,189,96,153],{from: accounts[0]});
  });
  ...
  it('Should execute testdebugRevert1(string)', async () => {
    let result = await contractProxyDebuggable.testdebugRevert1("9bkhh",{from: accounts[0]});
  });
