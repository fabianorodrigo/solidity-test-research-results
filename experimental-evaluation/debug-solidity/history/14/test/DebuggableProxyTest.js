...
contract("contractProxyDebuggable",(accounts)=>{
  ...
  it('Should execute testdebug0(string)', async () => {
    let result = await contractProxyDebuggable.testdebug0("ehd4zl",{from: accounts[0]});
  });
  it('Should execute testdebug1(bytes32)', async () => {
    let result = await contractProxyDebuggable.testdebug1([48,158,165,162,119,148,71,213,231,139,34,226,0,239,82,190,176,60,34,99,246,201,231,103,185,136,159,220,51,83,33,255],{from: accounts[0]});
  });
  ...
  it('Should execute testdebugRevert1(string)', async () => {
    let result = await contractProxyDebuggable.testdebugRevert1("tnjmxf",{from: accounts[0]});
  });
