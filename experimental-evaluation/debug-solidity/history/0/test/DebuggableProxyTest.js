...
contract("contractProxyDebuggable",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractDebugCounter = await DebugCounter.new("5l9dzi",{from:accounts[0]});
    if(trace) console.log('SUCESSO: DebugCounter.new("5l9dzi",{from:accounts[0]}');
  ...
  it('Should execute testdebug0(string)', async () => {
    let result = await contractProxyDebuggable.testdebug0("5l9dzi",{from: accounts[0]});
  });
  it('Should execute testdebug1(bytes32)', async () => {
    let result = await contractProxyDebuggable.testdebug1([98,128,78,125,16,68,206,45,250,94,160,216,216,49,61,172,168,211,204,227,70,129,186,230,72,55,98,102,161,47,70,143],{from: accounts[0]});
  });
  it('Should execute testdebug2(uint256)', async () => {
    let result = await contractProxyDebuggable.testdebug2(0,{from: accounts[0]});
  });
  ...
  it('Should execute testdebugRevert1(string)', async () => {
    let result = await contractProxyDebuggable.testdebugRevert1("5l9dzi",{from: accounts[0]});
  });
