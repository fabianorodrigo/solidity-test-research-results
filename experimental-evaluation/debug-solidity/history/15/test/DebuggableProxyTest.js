...
contract("contractProxyDebuggable",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractDebugCounter = await DebugCounter.new("42n2v",{from:accounts[0]});
    if(trace) console.log('SUCESSO: DebugCounter.new("42n2v",{from:accounts[0]}');
  ...
  it('Should execute testdebug0(string)', async () => {
    let result = await contractProxyDebuggable.testdebug0("3x6of",{from: accounts[0]});
  });
  it('Should execute testdebug1(bytes32)', async () => {
    let result = await contractProxyDebuggable.testdebug1([93,179,208,87,99,175,228,17,130,35,247,31,202,3,66,214,14,177,76,7,231,234,63,77,235,166,1,53,102,57,208,151],{from: accounts[0]});
  });
  ...
  it('Should execute testdebugRevert1(string)', async () => {
    let result = await contractProxyDebuggable.testdebugRevert1("3x6of",{from: accounts[0]});
  });
