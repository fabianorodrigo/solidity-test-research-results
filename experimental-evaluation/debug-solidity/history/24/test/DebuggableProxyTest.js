...
contract("contractProxyDebuggable",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractDebugCounter = await DebugCounter.new("25610n",{from:accounts[0]});
    if(trace) console.log('SUCESSO: DebugCounter.new("25610n",{from:accounts[0]}');
  ...
  it('Should execute testdebug0(string)', async () => {
    let result = await contractProxyDebuggable.testdebug0("25610n",{from: accounts[0]});
  });
  it('Should execute testdebug1(bytes32)', async () => {
    let result = await contractProxyDebuggable.testdebug1([222,26,235,192,0,110,34,23,147,102,67,231,150,28,107,158,78,108,190,34,206,133,157,102,67,55,251,117,60,18,133,14],{from: accounts[0]});
  });
  ...
  it('Should execute testdebug3(address)', async () => {
    let result = await contractProxyDebuggable.testdebug3(accounts[2],{from: accounts[0]});
  });
  ...
  it('Should execute testdebugRevert1(string)', async () => {
    let result = await contractProxyDebuggable.testdebugRevert1("25610n",{from: accounts[0]});
  });
