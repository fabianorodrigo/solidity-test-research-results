...
contract("contractProxyDebuggable",(accounts)=>{
  ...
  it('Should execute testdebug0(string)', async () => {
    let result = await contractProxyDebuggable.testdebug0("z73en9",{from: accounts[0]});
  });
  it('Should execute testdebug1(bytes32)', async () => {
    let result = await contractProxyDebuggable.testdebug1([40,25,210,5,60,142,158,42,90,56,99,195,22,195,237,141,34,183,86,140,75,188,121,47,178,183,92,232,190,59,15,193],{from: accounts[0]});
  });
  ...
  it('Should execute testdebugRevert1(string)', async () => {
    let result = await contractProxyDebuggable.testdebugRevert1("lcmj5",{from: accounts[0]});
  });
