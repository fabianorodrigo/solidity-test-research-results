...
contract("HarbergerAds",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractHarbergerAds = await HarbergerAds.new(contractERC20test.address,2014223714,95,{from:accounts[0]});
    if(trace) console.log('SUCESSO: HarbergerAds.new(contractERC20test.address,2014223714,95,{from:accounts[0]}');
  });
  
  it('Should execute taxesDue(uint256) WHEN 1>0', async () => {
    let result = await contractHarbergerAds.taxesDue(1532892063,{from: accounts[0]});
  });
  it('Should execute balanceOf(address) WHEN balance>allowance', async () => {
    let result = await contractHarbergerAds.balanceOf(accounts[2],{from: accounts[0]});
  });
  it('Should execute balanceOf(address) WHEN balance<=allowance', async () => {
    let result = await contractHarbergerAds.balanceOf(accounts[0],{from: accounts[0]});
  });
  it('Should execute addProperty(uint256)', async () => {
    let result = await contractHarbergerAds.addProperty(0,{from: accounts[0]});
  });
  ...
  it('Should execute collectTaxes(uint256) WHEN taxes>0,taxes<=balance', async () => {
    let result = await contractHarbergerAds.collectTaxes(1,{from: accounts[0]});
  });
  it('Should execute collectTaxes(uint256) WHEN taxes<=0,taxes<=balance', async () => {
    let result = await contractHarbergerAds.collectTaxes(2014223714,{from: accounts[0]});
  });
  it('Should execute collectTaxes(uint256) WHEN balance>0,taxes>balance', async () => {
    let result = await contractHarbergerAds.collectTaxes(18,{from: accounts[0]});
  });
  it('Should execute collectTaxes(uint256) WHEN balance<=0,taxes>balance', async () => {
  ...
  it('Should execute buy(uint256,uint256,uint256) WHEN seller!=msg.sender', async () => {
    let result = await contractHarbergerAds.buy(1, 1532892063, 29,{from: accounts[3]});
  });
  it('Should execute buy(uint256,uint256,uint256) WHEN seller==msg.sender', async () => {
    let result = await contractHarbergerAds.buy(65, 1331007098, 65,{from: accounts[3]});
  });
  ...
  it('Should execute changeRecipient(uint256,address)', async () => {
    let result = await contractHarbergerAds.changeRecipient(29, accounts[1],{from: accounts[0]});
  });
});
