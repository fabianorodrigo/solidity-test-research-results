...
contract("HarbergerAds",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractHarbergerAds = await HarbergerAds.new(contractERC20test.address,2014223714,1331007097,{from:accounts[0]});
    if(trace) console.log('SUCESSO: HarbergerAds.new(contractERC20test.address,2014223714,1331007097,{from:accounts[0]}');
  });
  
  it('Should execute taxesDue(uint256) WHEN 1>0', async () => {
    let result = await contractHarbergerAds.taxesDue(18,{from: accounts[0]});
  });
  ...
  it('Should execute addProperty(uint256)', async () => {
    let result = await contractHarbergerAds.addProperty(64,{from: accounts[0]});
  });
  it('Should execute forecloseIfPossible(uint256)', async () => {
    let result = await contractHarbergerAds.forecloseIfPossible(2014223714,{from: accounts[0]});
  });
  ...
  it('Should execute buy(uint256,uint256,uint256) WHEN seller!=msg.sender', async () => {
    let result = await contractHarbergerAds.buy(19, 2014223714, 1331007098,{from: accounts[7]});
  });
  it('Should execute buy(uint256,uint256,uint256) WHEN seller==msg.sender', async () => {
    let result = await contractHarbergerAds.buy(28, 1331007097, 95,{from: accounts[8]});
  });
  ...
  it('Should execute changeRecipient(uint256,address)', async () => {
    let result = await contractHarbergerAds.changeRecipient(2014223715, accounts[8],{from: accounts[0]});
  });
});
