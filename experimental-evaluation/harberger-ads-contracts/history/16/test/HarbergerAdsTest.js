...
contract("HarbergerAds",(accounts)=>{
  ...
  it('Should execute buy(uint256,uint256,uint256) WHEN seller!=msg.sender', async () => {
    let result = await contractHarbergerAds.buy(3, 5, 95,{from: accounts[6]});
  });
  it('Should execute buy(uint256,uint256,uint256) WHEN seller==msg.sender', async () => {
    let result = await contractHarbergerAds.buy(97, 64, 2014223715,{from: accounts[2]});
  });
  ...
  it('Should execute changeRecipient(uint256,address)', async () => {
    let result = await contractHarbergerAds.changeRecipient(97, accounts[7],{from: accounts[0]});
  });
});
