...
contract("contractProxyEndOfMonthConvention",(accounts)=>{
  ...
  it('Should execute testshiftEndOfMonth(uint256)', async () => {
    let result = await contractProxyEndOfMonthConvention.testshiftEndOfMonth(86400,{from: accounts[0]});
  });
  it('Should execute testshiftSameDay(uint256)', async () => {
    let result = await contractProxyEndOfMonthConvention.testshiftSameDay(160,{from: accounts[0]});
  });
});
