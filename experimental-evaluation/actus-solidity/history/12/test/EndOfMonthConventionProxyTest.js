...
contract("contractProxyEndOfMonthConvention",(accounts)=>{
  ...
  it('Should execute testshiftEndOfMonth(uint256)', async () => {
    let result = await contractProxyEndOfMonthConvention.testshiftEndOfMonth(28,{from: accounts[0]});
  });
  it('Should execute testshiftSameDay(uint256)', async () => {
    let result = await contractProxyEndOfMonthConvention.testshiftSameDay(2446,{from: accounts[0]});
  });
});
