...
contract("Splitter",(accounts)=>{
  ...
  it('Should execute splitEther(address,address) WHEN msg.sender==_owner,msg.value>0,running==true,receiver1!=0x0000000000000000000000000000000000000000,receiver2!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractSplitter.splitEther(accounts[9], accounts[5],{from: accounts[0],value:10000});
  });
  it('Should fail splitEther(address,address) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractSplitter.splitEther(accounts[9], accounts[5],{from: accounts[9],value:10000}),'revert');
  });
  it('Should fail splitEther(address,address) when NOT comply with: msg.value > 0', async () => {
    let result = await truffleAssert.fails(contractSplitter.splitEther(accounts[9], accounts[5],{from: accounts[0]}),'revert');
  });
  it('Should fail splitEther(address,address) when NOT comply with: running == true', async () => {
    ...
    let result = await truffleAssert.fails(contractSplitter.splitEther(accounts[9], accounts[5],{from: accounts[0],value:10000}),'revert');
  });
  ...
  it('Should fail splitEther(address,address) when NOT comply with: receiver2 != 0x0000000000000000000000000000000000000000', async () => {
    let result = await truffleAssert.fails(contractSplitter.splitEther(accounts[9], "0x0000000000000000000000000000000000000000",{from: accounts[0],value:10000}),'revert');
  });
