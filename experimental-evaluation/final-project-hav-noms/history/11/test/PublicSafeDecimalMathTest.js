...
contract("PublicSafeDecimalMath",(accounts)=>{
  ...
  it('Should execute multiplyDecimal(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.multiplyDecimal(2, 66,{from: accounts[0]});
  });
  it('Should execute multiplyDecimalRound(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.multiplyDecimalRound(257, 60,{from: accounts[0]});
  });
  it('Should execute multiplyDecimalRoundPrecise(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.multiplyDecimalRoundPrecise(19, 10,{from: accounts[0]});
  });
  it('Should execute divideDecimal(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.divideDecimal(66, 11,{from: accounts[0]});
  });
  it('Should execute divideDecimalRound(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.divideDecimalRound(64, 1532892063,{from: accounts[0]});
  });
  it('Should execute divideDecimalRoundPrecise(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.divideDecimalRoundPrecise(3, 95,{from: accounts[0]});
  });
  it('Should execute decimalToPreciseDecimal(uint)', async () => {
    let result = await contractPublicSafeDecimalMath.decimalToPreciseDecimal(31,{from: accounts[0]});
  });
  it('Should execute preciseDecimalToDecimal(uint)', async () => {
    let result = await contractPublicSafeDecimalMath.preciseDecimalToDecimal(20,{from: accounts[0]});
  });
});
