...
contract("PublicSafeDecimalMath",(accounts)=>{
  ...
  it('Should execute multiplyDecimal(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.multiplyDecimal(71, 55,{from: accounts[0]});
  });
  it('Should execute multiplyDecimalRound(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.multiplyDecimalRound(1, 2014223714,{from: accounts[0]});
  });
  it('Should execute multiplyDecimalRoundPrecise(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.multiplyDecimalRoundPrecise(59, 199999,{from: accounts[0]});
  });
  it('Should execute divideDecimal(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.divideDecimal(56, 199999,{from: accounts[0]});
  });
  it('Should execute divideDecimalRound(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.divideDecimalRound(200001, 54,{from: accounts[0]});
  });
  it('Should execute divideDecimalRoundPrecise(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.divideDecimalRoundPrecise(199999, 23,{from: accounts[0]});
  });
  it('Should execute decimalToPreciseDecimal(uint)', async () => {
    let result = await contractPublicSafeDecimalMath.decimalToPreciseDecimal(10001,{from: accounts[0]});
  });
  it('Should execute preciseDecimalToDecimal(uint)', async () => {
    let result = await contractPublicSafeDecimalMath.preciseDecimalToDecimal(102,{from: accounts[0]});
  });
});
