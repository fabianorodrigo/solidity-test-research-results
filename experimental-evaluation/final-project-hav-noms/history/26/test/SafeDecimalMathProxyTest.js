...
contract("contractProxySafeDecimalMath",(accounts)=>{
  ...
  it('Should execute testmultiplyDecimal(uint,uint) WHEN UNIT>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimal(49, 59,{from: accounts[0]});
  });
  it('Should execute testmultiplyDecimalRoundPrecise(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimalRoundPrecise(69, 60,{from: accounts[0]});
  });
  it('Should execute testmultiplyDecimalRound(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimalRound(58, 61,{from: accounts[0]});
  });
  it('Should execute testdivideDecimal(uint,uint) WHEN y>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimal(17, 26,{from: accounts[0]});
  });
  it('Should fail testdivideDecimal(uint,uint) when NOT comply with: y > 0', async () => {
    let result = await truffleAssert.fails(contractProxySafeDecimalMath.testdivideDecimal(17, 0,{from: accounts[0]}),'revert');
  });
  it('Should execute testdivideDecimalRound(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimalRound(1338, 98,{from: accounts[0]});
  });
  it('Should execute testdivideDecimalRoundPrecise(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimalRoundPrecise(10000, 2,{from: accounts[0]});
  });
  it('Should execute testdecimalToPreciseDecimal(uint)', async () => {
    let result = await contractProxySafeDecimalMath.testdecimalToPreciseDecimal(128,{from: accounts[0]});
  });
  it('Should execute testpreciseDecimalToDecimal(uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testpreciseDecimalToDecimal(27,{from: accounts[0]});
  });
});
