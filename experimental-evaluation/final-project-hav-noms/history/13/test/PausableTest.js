...
contract("Pausable",(accounts)=>{
  ...
  it('Should execute setPaused(bool) WHEN _paused==paused,msg.sender==_owner', async () => {
    let result = await contractPausable.setPaused(false,{from: accounts[0]});
  });
  it('Should fail setPaused(bool) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractPausable.setPaused(false,{from: accounts[9]}),'revert');
  });
  it('Should execute setPaused(bool) WHEN _paused!=paused,msg.sender==_owner', async () => {
    let result = await contractPausable.setPaused(true,{from: accounts[0]});
  });
  it('Should fail setPaused(bool) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractPausable.setPaused(true,{from: accounts[9]}),'revert');
  });
  it('Should execute setPaused(bool) WHEN paused==true,msg.sender==_owner', async () => {
    let result = await contractPausable.setPaused(false,{from: accounts[0]});
  });
  it('Should fail setPaused(bool) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractPausable.setPaused(false,{from: accounts[9]}),'revert');
  });
  it('Should execute setPaused(bool) WHEN paused!=true,_paused!=paused,msg.sender==_owner', async () => {
    let result = await contractPausable.setPaused(true,{from: accounts[0]});
  });
  it('Should fail setPaused(bool) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractPausable.setPaused(true,{from: accounts[9]}),'revert');
