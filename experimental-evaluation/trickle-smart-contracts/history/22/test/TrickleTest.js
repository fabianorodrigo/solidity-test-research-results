...
contract("Trickle",(accounts)=>{
  ...
  it('Should execute createAgreement(IERC20,address,uint256,uint48,uint48) WHEN duration>0,totalAmount>0,start>0,recipient!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractTrickle.createAgreement(contractERC20Mock.address, accounts[7], 2, 97, 256,{from: accounts[0]});
  });
  it('Should fail createAgreement(IERC20,address,uint256,uint48,uint48) when NOT comply with: duration > 0', async () => {
    let result = await truffleAssert.fails(contractTrickle.createAgreement(contractERC20Mock.address, accounts[7], 2, 0, 256,{from: accounts[0]}),'revert');
  });
  it('Should fail createAgreement(IERC20,address,uint256,uint48,uint48) when NOT comply with: totalAmount > 0', async () => {
    let result = await truffleAssert.fails(contractTrickle.createAgreement(contractERC20Mock.address, accounts[7], 0, 97, 256,{from: accounts[0]}),'revert');
  });
  it('Should fail createAgreement(IERC20,address,uint256,uint48,uint48) when NOT comply with: start > 0', async () => {
    let result = await truffleAssert.fails(contractTrickle.createAgreement(contractERC20Mock.address, accounts[7], 2, 97, 0,{from: accounts[0]}),'revert');
  });
  it('Should fail createAgreement(IERC20,address,uint256,uint48,uint48) when NOT comply with: recipient != 0x0000000000000000000000000000000000000000', async () => {
    let result = await truffleAssert.fails(contractTrickle.createAgreement(contractERC20Mock.address, "0x0000000000000000000000000000000000000000", 2, 97, 256,{from: accounts[0]}),'revert');
  });
  it('Should execute getAgreement(uint256)', async () => {
    let result = await contractTrickle.getAgreement(1532892062,{from: accounts[0]});
  });
  ...
  it('Should execute withdrawableAmount(uint256)', async () => {
    let result = await contractTrickle.withdrawableAmount(48,{from: accounts[0]});
  });
});
