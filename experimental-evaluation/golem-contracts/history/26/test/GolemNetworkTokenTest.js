...
contract("GolemNetworkToken",(accounts)=>{
  ...
  it('Should execute transfer(address,uint256) WHEN senderBalance>=_value,_value>0', async () => {
    let result = await contractGolemNetworkToken.transfer(accounts[8], 17,{from: accounts[0]});
  });
  ...
  it('Should execute balanceOf(address)', async () => {
    let result = await contractGolemNetworkToken.balanceOf(accounts[1],{from: accounts[0]});
  });
  it('Should execute migrate(uint256) WHEN migrationAgent!=0x0000000000000000000000000000000000000000,_value!=0,_value<=balances', async () => {
    await contractGolemNetworkToken.setMigrationAgent(accounts[6],{from:accounts[6]});
    let result = await contractGolemNetworkToken.migrate(18,{from: accounts[6]});
  });
  it('Should fail migrate(uint256) when NOT comply with: migrationAgent != 0x0000000000000000000000000000000000000000', async () => {
    await contractGolemNetworkToken.setMigrationAgent("0x0000000000000000000000000000000000000000",{from:accounts[6]});
    let result = await truffleAssert.fails(contractGolemNetworkToken.migrate(18,{from: accounts[6]}),'revert');
  });
  it('Should fail migrate(uint256) when NOT comply with: _value != 0', async () => {
    await contractGolemNetworkToken.setMigrationAgent(accounts[6],{from:accounts[6]});
    let result = await truffleAssert.fails(contractGolemNetworkToken.migrate(0,{from: accounts[6]}),'revert');
  });
  it('Should execute setMigrationAgent(address) WHEN migrationAgent==0x0000000000000000000000000000000000000000,msg.sender==migrationMaster', async () => {
    let result = await contractGolemNetworkToken.setMigrationAgent(accounts[0],{from: accounts[6]});
  });
  ...
  it('Should execute setMigrationMaster(address) WHEN msg.sender==migrationMaster,_master!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractGolemNetworkToken.setMigrationMaster(accounts[3],{from: accounts[6]});
  });
  ...
  it('Should fail setMigrationMaster(address) when NOT comply with: _master != 0x0000000000000000000000000000000000000000', async () => {
    let result = await truffleAssert.fails(contractGolemNetworkToken.setMigrationMaster("0x0000000000000000000000000000000000000000",{from: accounts[6]}),'revert');
  });
  it('Should execute create() WHEN funding==true,(await web3.eth.getBlockNumber())>=fundingStartBlock,(await web3.eth.getBlockNumber())<=fundingEndBlock,msg.value!=0', async () => {
    let localGolemNetworkToken = await GolemNetworkToken.new(accounts[8],accounts[9],(await web3.eth.getBlockNumber())+665,(await web3.eth.getBlockNumber())+665+340,{from:accounts[0]});
    let result = await localGolemNetworkToken.create({from: accounts[0],value:16});
  });
  it('Should fail create() when NOT comply with: funding == true', async () => {
    let localGolemNetworkToken = await GolemNetworkToken.new(accounts[8],accounts[9],(await web3.eth.getBlockNumber())+665,(await web3.eth.getBlockNumber())+665+340,{from:accounts[0]});
    await localGolemNetworkToken.finalize({from:accounts[0],value:16});
    let result = await truffleAssert.fails(localGolemNetworkToken.create({from: accounts[0],value:16}),'revert');
  });
  ...
  it('Should execute refund() WHEN funding==true,(await web3.eth.getBlockNumber())>fundingEndBlock,totalTokens<tokenCreationMin,gntValue!=0,FunctionCall==true', async () => {
    let localGolemNetworkToken = await GolemNetworkToken.new(accounts[1],accounts[9],(await web3.eth.getBlockNumber())+57,(await web3.eth.getBlockNumber())+57+227,{from:accounts[0]});
