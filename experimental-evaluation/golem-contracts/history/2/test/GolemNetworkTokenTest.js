...
contract("GolemNetworkToken",(accounts)=>{
  ...
  it('Should execute transfer(address,uint256) WHEN senderBalance>=_value,_value>0', async () => {
    let result = await contractGolemNetworkToken.transfer(accounts[8], 1337,{from: accounts[0]});
  });
  it('Should execute transfer(address,uint256) WHEN _value<=0', async () => {
    let result = await contractGolemNetworkToken.transfer(accounts[2], 0,{from: accounts[0]});
  });
  it('Should execute totalSupply()', async () => {
    let result = await contractGolemNetworkToken.totalSupply({from: accounts[0]});
  });
  it('Should execute balanceOf(address)', async () => {
    let result = await contractGolemNetworkToken.balanceOf(accounts[4],{from: accounts[0]});
  });
  it('Should execute migrate(uint256) WHEN migrationAgent!=0x0000000000000000000000000000000000000000,_value!=0,_value<=balances', async () => {
    await contractGolemNetworkToken.setMigrationAgent(accounts[3],{from:accounts[9]});
    let result = await contractGolemNetworkToken.migrate(999,{from: accounts[9]});
  });
  it('Should fail migrate(uint256) when NOT comply with: migrationAgent != 0x0000000000000000000000000000000000000000', async () => {
    await contractGolemNetworkToken.setMigrationAgent("0x0000000000000000000000000000000000000000",{from:accounts[9]});
    let result = await truffleAssert.fails(contractGolemNetworkToken.migrate(999,{from: accounts[9]}),'revert');
  });
  it('Should fail migrate(uint256) when NOT comply with: _value != 0', async () => {
    await contractGolemNetworkToken.setMigrationAgent(accounts[3],{from:accounts[9]});
    let result = await truffleAssert.fails(contractGolemNetworkToken.migrate(0,{from: accounts[9]}),'revert');
  });
  it('Should execute setMigrationAgent(address) WHEN migrationAgent==0x0000000000000000000000000000000000000000,msg.sender==migrationMaster', async () => {
    let result = await contractGolemNetworkToken.setMigrationAgent(accounts[7],{from: accounts[9]});
  });
  it('Should fail setMigrationAgent(address) when NOT comply with: msg.sender == migrationMaster', async () => {
    let result = await truffleAssert.fails(contractGolemNetworkToken.setMigrationAgent(accounts[7],{from: accounts[8]}),'revert');
  });
  it('Should execute setMigrationMaster(address) WHEN msg.sender==migrationMaster,_master!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractGolemNetworkToken.setMigrationMaster(accounts[4],{from: accounts[9]});
  });
  it('Should fail setMigrationMaster(address) when NOT comply with: msg.sender == migrationMaster', async () => {
    let result = await truffleAssert.fails(contractGolemNetworkToken.setMigrationMaster(accounts[4],{from: accounts[8]}),'revert');
  });
  it('Should fail setMigrationMaster(address) when NOT comply with: _master != 0x0000000000000000000000000000000000000000', async () => {
    let result = await truffleAssert.fails(contractGolemNetworkToken.setMigrationMaster("0x0000000000000000000000000000000000000000",{from: accounts[9]}),'revert');
  });
  it('Should execute create() WHEN funding==true,(await web3.eth.getBlockNumber())>=fundingStartBlock,(await web3.eth.getBlockNumber())<=fundingEndBlock,msg.value!=0', async () => {
    let localGolemNetworkToken = await GolemNetworkToken.new(accounts[7],accounts[0],(await web3.eth.getBlockNumber())+604,(await web3.eth.getBlockNumber())+604+325,{from:accounts[0]});
    let result = await localGolemNetworkToken.create({from: accounts[0],value:10001});
  });
  it('Should fail create() when NOT comply with: funding == true', async () => {
    let localGolemNetworkToken = await GolemNetworkToken.new(accounts[7],accounts[0],(await web3.eth.getBlockNumber())+604,(await web3.eth.getBlockNumber())+604+325,{from:accounts[0]});
    await localGolemNetworkToken.finalize({from:accounts[0],value:10001});
    let result = await truffleAssert.fails(localGolemNetworkToken.create({from: accounts[0],value:10001}),'revert');
  });
  ...
  it('Should execute refund() WHEN funding==true,(await web3.eth.getBlockNumber())>fundingEndBlock,totalTokens<tokenCreationMin,gntValue!=0,FunctionCall==true', async () => {
    let localGolemNetworkToken = await GolemNetworkToken.new(accounts[9],accounts[6],(await web3.eth.getBlockNumber())+809,(await web3.eth.getBlockNumber())+809+331,{from:accounts[0]});
