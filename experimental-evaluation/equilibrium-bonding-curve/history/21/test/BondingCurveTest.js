...
contract("BondingCurve",(accounts)=>{
  ...
  it('Should execute buyTokens(uint256,uint256) WHEN supply>0', async () => {
    let result = await contractBondingCurve.buyTokens(129, 128,{from: accounts[0]});
  });
  it('Should execute buyTokens(uint256,uint256) WHEN supply<=0', async () => {
    await contractBondingCurve.sellTokens(256,{from:accounts[0]});
    let result = await contractBondingCurve.buyTokens(127, 257,{from: accounts[0]});
  });
  it('Should execute buyTokens(uint256,uint256) WHEN supply==0', async () => {
  ...
  it('Should execute buyTokens(uint256,uint256) WHEN supply!=0', async () => {
    let result = await contractBondingCurve.buyTokens(9999, 3,{from: accounts[0]});
  });
  ...
  it('Should execute changeTargetPrice(uint256)', async () => {
    let result = await contractBondingCurve.changeTargetPrice(2,{from: accounts[0]});
  });
