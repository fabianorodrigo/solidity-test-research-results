...
contract("BondingCurve",(accounts)=>{
  ...
  it('Should execute buyTokens(uint256,uint256) WHEN supply<=0', async () => {
    ...
    let result = await contractBondingCurve.buyTokens(129, 127,{from: accounts[0]});
  });
  it('Should execute buyTokens(uint256,uint256) WHEN supply==0', async () => {
    await contractBondingCurve.sellTokens(0,{from:accounts[0]});
    let result = await contractBondingCurve.buyTokens(100, 10000,{from: accounts[0]});
  });
  it('Should execute buyTokens(uint256,uint256) WHEN supply!=0', async () => {
    let result = await contractBondingCurve.buyTokens(127, 100,{from: accounts[0]});
  });
  it('Should execute sellTokens(uint256)', async () => {
    let result = await contractBondingCurve.sellTokens(3,{from: accounts[0]});
  });
  it('Should execute changeTargetPrice(uint256)', async () => {
    let result = await contractBondingCurve.changeTargetPrice(1,{from: accounts[0]});
  });
  it('Should execute queryNextPrice() WHEN supply>0', async () => {
    let result = await contractBondingCurve.queryNextPrice({from: accounts[0]});
  });
  it('Should execute queryNextPrice() WHEN supply==0', async () => {
    await contractBondingCurve.buyTokens(10001,1,{from:accounts[0]});
    let result = await contractBondingCurve.queryNextPrice({from: accounts[0]});
  });
  it('Should execute queryNextPrice() WHEN supply!=0', async () => {
    let result = await contractBondingCurve.queryNextPrice({from: accounts[0]});
