...
contract("NOIAToken",(accounts)=>{
  ...
  it('Should execute transferFrom(address,address,uint256) WHEN success==true', async () => {
    let result = await contractNOIAToken.methods["transferFrom(address,address,uint256)"](accounts[7], contractNOIAVault.address, 1532892062,{from: accounts[0]});
  });
  it('Should execute transferFrom(address,address,uint256) WHEN success!=true', async () => {
    let result = await contractNOIAToken.methods["transferFrom(address,address,uint256)"](accounts[7], contractNOIAVault.address, 5,{from: accounts[0]});
  });
  it('Should execute mint(address,uint256) WHEN msg.sender==_owner,to!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractNOIAToken.mint(accounts[5], 27,{from: accounts[0]});
  });
  it('Should fail mint(address,uint256) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractNOIAToken.mint(accounts[5], 27,{from: accounts[9]}),'revert');
  });
  it('Should fail mint(address,uint256) when NOT comply with: to != 0x0000000000000000000000000000000000000000', async () => {
    let result = await truffleAssert.fails(contractNOIAToken.mint("0x0000000000000000000000000000000000000000", 27,{from: accounts[0]}),'revert');
  });
  it('Should execute burn(uint256) WHEN msg.sender==burnAddress,tokensToMint==0,msg.sender!=0x0000000000000000000000000000000000000000', async () => {
    ...
    await contractNOIAToken.mint(accounts[4],256,{from:accounts[0]});
    let result = await contractNOIAToken.burn(1532892062,{from: accounts[6]});
  });
  it('Should fail burn(uint256) when NOT comply with: msg.sender == burnAddress', async () => {
    await contractNOIAToken.setBurnAddress(accounts[6],{from:accounts[0]});
    await contractNOIAToken.mint(accounts[4],256,{from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.burn(1532892062,{from: accounts[9]}),'revert');
  });
  it('Should fail burn(uint256) when NOT comply with: tokensToMint == 0', async () => {
    await contractNOIAToken.setBurnAddress(accounts[6],{from:accounts[0]});
    await contractNOIAToken.mint(accounts[9],1336,{from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.burn(1532892062,{from: accounts[6]}),'revert');
  });
  it('Should fail burn(uint256) when NOT comply with: msg.sender != 0x0000000000000000000000000000000000000000', async () => {
    await contractNOIAToken.setBurnAddress(accounts[6],{from:accounts[0]});
    await contractNOIAToken.mint(accounts[4],256,{from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.burn(1532892062,{from: 0}),'revert');
  });
  ...
  it('Should execute transferPreSigned(bytes,address,uint256,uint256,uint256) WHEN msg.sender==_to,etherlessTransferEnabled==true,_to!=0x0000000000000000000000000000000000000000,from!=0x0000000000000000000000000000000000000000,hashedTxs==false,_to!=0x0000000000000000000000000000000000000000', async () => {
    ...
    let result = await contractNOIAToken.transferPreSigned([59,23,23,1,72,83,253,174,107,160,173,199,133,163,53,88,166,89,73,168,109,62,120,223,45,241,94,205,58,37,211,202], accounts[0], 257, 2, 19,{from: accounts[0]});
  });
  it('Should fail transferPreSigned(bytes,address,uint256,uint256,uint256) when NOT comply with: etherlessTransferEnabled == true', async () => {
    ...
    let result = await truffleAssert.fails(contractNOIAToken.transferPreSigned([59,23,23,1,72,83,253,174,107,160,173,199,133,163,53,88,166,89,73,168,109,62,120,223,45,241,94,205,58,37,211,202], accounts[0], 257, 2, 19,{from: accounts[0]}),'revert');
  });
  it('Should fail transferPreSigned(bytes,address,uint256,uint256,uint256) when NOT comply with: _to != 0x0000000000000000000000000000000000000000', async () => {
    await contractNOIAToken.enableEtherlessTransfer({from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.transferPreSigned([59,23,23,1,72,83,253,174,107,160,173,199,133,163,53,88,166,89,73,168,109,62,120,223,45,241,94,205,58,37,211,202], "0x0000000000000000000000000000000000000000", 257, 2, 19,{from: accounts[0]}),'revert');
  });
  it('Should fail transferPreSigned(bytes,address,uint256,uint256,uint256) when NOT comply with: _to != 0x0000000000000000000000000000000000000000', async () => {
    await contractNOIAToken.enableEtherlessTransfer({from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.transferPreSigned([59,23,23,1,72,83,253,174,107,160,173,199,133,163,53,88,166,89,73,168,109,62,120,223,45,241,94,205,58,37,211,202], "0x0000000000000000000000000000000000000000", 257, 2, 19,{from: accounts[0]}),'revert');
  ...
  it('Should execute transferPreSigned(bytes,address,uint256,uint256,uint256) WHEN msg.sender!=_to,etherlessTransferEnabled==true,_to!=0x0000000000000000000000000000000000000000,from!=0x0000000000000000000000000000000000000000,hashedTxs==false', async () => {
    await contractNOIAToken.enableEtherlessTransfer({from:accounts[0]});
    let result = await contractNOIAToken.transferPreSigned([225,160,149,103,66,226,128,101,59,86,162,150,212,75,255,189,175,170,120,58,3,71,209,120,68,160,87,203,146,213,155,146], accounts[9], 1, 66, 6,{from: accounts[5]});
  });
  it('Should fail transferPreSigned(bytes,address,uint256,uint256,uint256) when NOT comply with: etherlessTransferEnabled == true', async () => {
    await contractNOIAToken.enableEtherlessTransfer({from:accounts[0]});
    await contractNOIAToken.disableEtherlessTransfer({from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.transferPreSigned([225,160,149,103,66,226,128,101,59,86,162,150,212,75,255,189,175,170,120,58,3,71,209,120,68,160,87,203,146,213,155,146], accounts[9], 1, 66, 6,{from: accounts[5]}),'revert');
  });
  it('Should fail transferPreSigned(bytes,address,uint256,uint256,uint256) when NOT comply with: _to != 0x0000000000000000000000000000000000000000', async () => {
    await contractNOIAToken.enableEtherlessTransfer({from:accounts[0]});
    let result = await truffleAssert.fails(contractNOIAToken.transferPreSigned([225,160,149,103,66,226,128,101,59,86,162,150,212,75,255,189,175,170,120,58,3,71,209,120,68,160,87,203,146,213,155,146], "0x0000000000000000000000000000000000000000", 1, 66, 6,{from: accounts[5]}),'revert');
  });
  it('Should execute hashForSign(bytes4,address,address,uint256,uint256,uint256)', async () => {
    let result = await contractNOIAToken.hashForSign([96,253,81,207], accounts[5], accounts[5], 65, 255, 1532892062,{from: accounts[0]});
  });
});
