...
contract("Aiakos",(accounts)=>{
  ...
  it('Should execute deployRelease(string,bytes32) WHEN MemberAccess.Identifier!=true', async () => {
    let result = await contractAiakos.deployRelease("\x19Ethereum Signed Message:\n32", [23,77,117,98,140,157,102,248,29,216,128,200,28,96,92,114,230,13,219,197,252,29,87,150,190,152,133,45,203,168,65,181],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN MemberAccess.Identifier==true', async () => {
    let result = await contractAiakos.deployRelease("IsLibrary", [151,70,15,19,120,78,110,221,252,165,59,70,99,246,218,235,239,230,90,109,246,6,220,81,203,47,92,255,212,208,27,245],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN approvalGranted==true', async () => {
    let result = await contractAiakos.deployRelease("superuser", [224,56,62,26,177,99,195,111,230,178,250,74,82,217,42,143,102,212,129,177,103,74,188,254,57,14,206,54,7,17,22,214],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN approvalGranted!=true', async () => {
    let result = await contractAiakos.deployRelease("PayableExample", [140,86,131,163,190,31,171,25,34,228,29,237,221,196,61,47,33,106,18,132,184,166,146,173,230,187,251,192,100,234,144,73],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN releaseApproved==true', async () => {
    let result = await contractAiakos.deployRelease("UsesExample", [94,172,209,237,24,13,144,186,42,109,10,15,159,14,93,177,98,11,179,173,228,98,91,122,24,86,4,164,11,80,207,246],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN releaseApproved!=true,approvalGranted!=true', async () => {
    let result = await contractAiakos.deployRelease("RevertWithReason", [196,115,217,191,83,211,196,219,31,185,19,149,70,117,156,236,102,79,65,145,188,17,105,47,196,85,216,157,89,184,103,234],{from: accounts[0]});
  });
  it('Should execute checkRelease(string,bytes32) WHEN _sha256Hash!=0x0,MemberAccess.Identifier==true', async () => {
    let result = await contractAiakos.checkRelease("superuser", [151,125,158,66,83,143,239,228,203,76,204,10,98,199,101,65,228,31,244,9,175,2,19,76,215,201,41,82,50,222,148,214],{from: accounts[0]});
  });
