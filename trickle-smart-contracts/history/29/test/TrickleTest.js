...
contract("Trickle",(accounts)=>{
  ...
  beforeEach(async () => {
    ...
    contractERC20Mock = await ERC20Mock.new(accounts[4],255,{from:accounts[0]});
    if(trace) console.log('SUCESSO: ERC20Mock.new(accounts[4],255,{from:accounts[0]}');
  });
  ...
  it('Should execute createAgreement(IERC20,address,uint256,uint48,uint48) WHEN duration>0,totalAmount>0,start>0,recipient!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractTrickle.createAgreement(contractERC20Mock.address, accounts[9], 2014223715, 26, 95,{from: accounts[0]});
  });
  it('Should fail createAgreement(IERC20,address,uint256,uint48,uint48) when NOT comply with: duration > 0', async () => {
    let result = await truffleAssert.fails(contractTrickle.createAgreement(contractERC20Mock.address, accounts[9], 2014223715, 0, 95,{from: accounts[0]}),'revert');
  });
  it('Should fail createAgreement(IERC20,address,uint256,uint48,uint48) when NOT comply with: totalAmount > 0', async () => {
    let result = await truffleAssert.fails(contractTrickle.createAgreement(contractERC20Mock.address, accounts[9], 0, 26, 95,{from: accounts[0]}),'revert');
  });
  it('Should fail createAgreement(IERC20,address,uint256,uint48,uint48) when NOT comply with: start > 0', async () => {
    let result = await truffleAssert.fails(contractTrickle.createAgreement(contractERC20Mock.address, accounts[9], 2014223715, 26, 0,{from: accounts[0]}),'revert');
  });
  it('Should fail createAgreement(IERC20,address,uint256,uint48,uint48) when NOT comply with: recipient != 0x0000000000000000000000000000000000000000', async () => {
    let result = await truffleAssert.fails(contractTrickle.createAgreement(contractERC20Mock.address, "0x0000000000000000000000000000000000000000", 2014223715, 26, 95,{from: accounts[0]}),'revert');
  });
  ...
  it('Should execute cancelAgreement(uint256) WHEN canceledAmount<=0', async () => {
    let result = await contractTrickle.cancelAgreement(3,{from: accounts[0]});
  });
  it('Should execute withdrawableAmount(uint256)', async () => {
    let result = await contractTrickle.withdrawableAmount(1532892062,{from: accounts[0]});
  });
});
