...
contract("contractProxySafeDecimalMath",(accounts)=>{
  ...
  it('Should execute testmultiplyDecimal(uint,uint) WHEN UNIT>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimal(9999, 87,{from: accounts[0]});
  });
  it('Should execute testmultiplyDecimalRoundPrecise(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimalRoundPrecise(57, 98,{from: accounts[0]});
  });
  it('Should execute testmultiplyDecimalRound(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimalRound(6, 19,{from: accounts[0]});
  });
  it('Should execute testdivideDecimal(uint,uint) WHEN y>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimal(24, 66,{from: accounts[0]});
  });
  it('Should fail testdivideDecimal(uint,uint) when NOT comply with: y > 0', async () => {
    let result = await truffleAssert.fails(contractProxySafeDecimalMath.testdivideDecimal(24, 0,{from: accounts[0]}),'revert');
  });
  it('Should execute testdivideDecimalRound(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimalRound(1, 58,{from: accounts[0]});
  });
  it('Should execute testdivideDecimalRoundPrecise(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimalRoundPrecise(16, 33,{from: accounts[0]});
  });
  ...
  it('Should execute testpreciseDecimalToDecimal(uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testpreciseDecimalToDecimal(0,{from: accounts[0]});
  });
});
