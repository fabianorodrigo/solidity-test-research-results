...
contract("contractProxySafeDecimalMath",(accounts)=>{
  ...
  it('Should execute testmultiplyDecimal(uint,uint) WHEN UNIT>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimal(5, 45,{from: accounts[0]});
  });
  it('Should execute testmultiplyDecimalRoundPrecise(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimalRoundPrecise(56, 1336,{from: accounts[0]});
  });
  it('Should execute testmultiplyDecimalRound(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimalRound(31, 128,{from: accounts[0]});
  });
  it('Should execute testdivideDecimal(uint,uint) WHEN y>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimal(27, 19,{from: accounts[0]});
  });
  it('Should fail testdivideDecimal(uint,uint) when NOT comply with: y > 0', async () => {
    let result = await truffleAssert.fails(contractProxySafeDecimalMath.testdivideDecimal(27, 0,{from: accounts[0]}),'revert');
  });
  it('Should execute testdivideDecimalRound(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimalRound(71, 1532892064,{from: accounts[0]});
  });
  it('Should execute testdivideDecimalRoundPrecise(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimalRoundPrecise(1532892064, 257,{from: accounts[0]});
  });
  it('Should execute testdecimalToPreciseDecimal(uint)', async () => {
    let result = await contractProxySafeDecimalMath.testdecimalToPreciseDecimal(63,{from: accounts[0]});
  });
  it('Should execute testpreciseDecimalToDecimal(uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testpreciseDecimalToDecimal(4,{from: accounts[0]});
  });
});
