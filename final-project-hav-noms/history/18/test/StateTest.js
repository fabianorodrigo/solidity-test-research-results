...
contract("State",(accounts)=>{
  ...
  it('Should execute setAssociatedContract(address) WHEN msg.sender==_owner', async () => {
    let result = await contractState.setAssociatedContract(accounts[2],{from: accounts[0]});
  });
  it('Should fail setAssociatedContract(address) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractState.setAssociatedContract(accounts[2],{from: accounts[9]}),'revert');
  });
});
