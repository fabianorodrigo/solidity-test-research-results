...
contract("PublicSafeDecimalMath",(accounts)=>{
  ...
  it('Should execute multiplyDecimal(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.multiplyDecimal(48, 23,{from: accounts[0]});
  });
  it('Should execute multiplyDecimalRound(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.multiplyDecimalRound(0, 3,{from: accounts[0]});
  });
  it('Should execute multiplyDecimalRoundPrecise(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.multiplyDecimalRoundPrecise(102, 128,{from: accounts[0]});
  });
  it('Should execute divideDecimal(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.divideDecimal(15, 57,{from: accounts[0]});
  });
  it('Should execute divideDecimalRound(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.divideDecimalRound(56, 0,{from: accounts[0]});
  });
  it('Should execute divideDecimalRoundPrecise(uint,uint)', async () => {
    let result = await contractPublicSafeDecimalMath.divideDecimalRoundPrecise(65, 46,{from: accounts[0]});
  });
  it('Should execute decimalToPreciseDecimal(uint)', async () => {
    let result = await contractPublicSafeDecimalMath.decimalToPreciseDecimal(1338,{from: accounts[0]});
  });
