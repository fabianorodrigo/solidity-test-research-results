...
contract("contractProxySafeDecimalMath",(accounts)=>{
  ...
  it('Should execute testmultiplyDecimal(uint,uint) WHEN UNIT>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimal(1336, 6,{from: accounts[0]});
  });
  it('Should execute testmultiplyDecimalRoundPrecise(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimalRoundPrecise(65, 59,{from: accounts[0]});
  });
  it('Should execute testmultiplyDecimalRound(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testmultiplyDecimalRound(23, 256,{from: accounts[0]});
  });
  it('Should execute testdivideDecimal(uint,uint) WHEN y>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimal(63, 2014223715,{from: accounts[0]});
  });
  it('Should fail testdivideDecimal(uint,uint) when NOT comply with: y > 0', async () => {
    let result = await truffleAssert.fails(contractProxySafeDecimalMath.testdivideDecimal(63, 0,{from: accounts[0]}),'revert');
  });
  it('Should execute testdivideDecimalRound(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimalRound(49, 20,{from: accounts[0]});
  });
  it('Should execute testdivideDecimalRoundPrecise(uint,uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testdivideDecimalRoundPrecise(1338, 18,{from: accounts[0]});
  });
  it('Should execute testdecimalToPreciseDecimal(uint)', async () => {
    let result = await contractProxySafeDecimalMath.testdecimalToPreciseDecimal(1025,{from: accounts[0]});
  });
  it('Should execute testpreciseDecimalToDecimal(uint) WHEN 10>0', async () => {
    let result = await contractProxySafeDecimalMath.testpreciseDecimalToDecimal(20,{from: accounts[0]});
  });
});
