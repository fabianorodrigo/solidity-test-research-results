...
contract("Aiakos",(accounts)=>{
  ...
  it('Should execute deployRelease(string,bytes32) WHEN MemberAccess.Identifier!=true', async () => {
    let result = await contractAiakos.deployRelease("RevertWithReason", [98,82,155,219,175,43,23,80,171,251,230,190,154,220,158,115,0,22,188,249,168,20,108,232,123,129,22,248,13,38,82,31],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN MemberAccess.Identifier==true', async () => {
    let result = await contractAiakos.deployRelease("z8iv1o", [254,68,65,187,73,76,144,19,238,214,160,158,99,166,209,244,189,10,49,29,110,248,44,252,45,100,182,213,23,35,169,10],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN approvalGranted==true', async () => {
    let result = await contractAiakos.deployRelease("PayableExample", [9,94,132,243,74,201,46,108,146,121,131,83,238,216,244,119,84,217,21,10,21,74,158,197,81,213,177,64,114,39,100,83],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN approvalGranted!=true', async () => {
    let result = await contractAiakos.deployRelease("ERC1820_ACCEPT_MAGIC", [236,67,233,228,23,27,156,168,42,224,111,205,163,140,81,11,39,80,69,80,238,74,97,38,60,7,186,31,224,207,170,117],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN releaseApproved==true', async () => {
    let result = await contractAiakos.deployRelease("RevertWithReason", [210,236,84,203,228,168,123,7,123,61,65,251,72,56,38,231,96,7,155,234,130,253,219,224,119,51,246,56,128,81,92,48],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN releaseApproved!=true,approvalGranted!=true', async () => {
    let result = await contractAiakos.deployRelease("ERC1820_ACCEPT_MAGIC", [86,174,20,107,150,233,211,116,187,203,199,87,186,21,66,167,50,37,212,174,244,43,122,125,58,233,201,240,176,63,234,102],{from: accounts[0]});
  });
  it('Should execute checkRelease(string,bytes32) WHEN _sha256Hash!=0x0,MemberAccess.Identifier==true', async () => {
    let result = await contractAiakos.checkRelease("Example", [238,55,164,125,217,240,149,224,190,255,146,188,29,175,186,140,227,134,249,49,243,215,127,75,171,36,17,195,53,160,205,209],{from: accounts[0]});
  });
  ...
  it('Should execute getReleaseInfo(string)', async () => {
    let result = await contractAiakos.getReleaseInfo("IsLibrary",{from: accounts[0]});
  });
  ...
  it('Should execute transferOwnership(address) WHEN _newOwner!=0x0000000000000000000000000000000000000000,msg.sender==_owner', async () => {
    let result = await contractAiakos.methods["transferOwnership(address)"](accounts[5],{from: accounts[0]});
  });
  ...
  it('Should fail transferOwnership(address) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractAiakos.methods["transferOwnership(address)"](accounts[5],{from: accounts[9]}),'revert');
  });
});
