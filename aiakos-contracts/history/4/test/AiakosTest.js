...
contract("Aiakos",(accounts)=>{
  ...
  it('Should execute addMaintainer(address) WHEN msg.sender==_owner,_maintainerAddress!=0x0000000000000000000000000000000000000000', async () => {
    let result = await contractAiakos.addMaintainer(accounts[6],{from: accounts[0]});
  });
  it('Should fail addMaintainer(address) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractAiakos.addMaintainer(accounts[6],{from: accounts[9]}),'revert');
  });
  ...
  it('Should execute deployRelease(string,bytes32) WHEN MemberAccess.Identifier!=true', async () => {
    let result = await contractAiakos.deployRelease("ERC1820_ACCEPT_MAGIC", [101,224,32,27,18,130,137,191,43,252,45,28,242,10,6,82,172,150,62,192,49,129,18,112,179,62,212,204,20,84,98,178],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN MemberAccess.Identifier==true', async () => {
    let result = await contractAiakos.deployRelease("ERC1820_ACCEPT_MAGIC", [225,227,42,128,215,153,127,252,184,152,152,81,178,45,55,84,190,168,153,108,193,139,75,109,57,230,205,234,125,173,172,232],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN approvalGranted==true', async () => {
    let result = await contractAiakos.deployRelease("\x19Ethereum Signed Message:\n32", [49,182,142,238,217,34,7,111,141,105,211,238,152,152,134,128,222,132,75,123,101,148,156,152,221,248,109,223,43,13,87,107],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN approvalGranted!=true', async () => {
    let result = await contractAiakos.deployRelease("minter", [135,34,18,70,144,117,60,117,78,44,112,150,130,172,110,90,134,8,236,237,172,26,10,216,2,68,24,88,118,117,18,209],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN releaseApproved==true', async () => {
    let result = await contractAiakos.deployRelease("superuser", [229,64,3,249,97,239,1,145,30,212,220,72,25,245,90,154,218,181,101,7,232,3,156,197,209,243,19,246,61,164,42,34],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN releaseApproved!=true,approvalGranted!=true', async () => {
    let result = await contractAiakos.deployRelease("bouncer", [79,208,190,33,5,150,11,171,205,242,38,252,161,127,195,198,223,255,14,89,236,171,187,254,83,191,182,225,14,211,181,50],{from: accounts[0]});
  });
  it('Should execute checkRelease(string,bytes32) WHEN _sha256Hash!=0x0,MemberAccess.Identifier==true', async () => {
    let result = await contractAiakos.checkRelease("superuser", [49,14,148,181,136,21,233,9,149,141,187,90,224,69,16,163,208,177,126,147,0,66,200,235,4,43,127,174,210,42,28,140],{from: accounts[0]});
  });
  it('Should fail checkRelease(string,bytes32) when NOT comply with: _sha256Hash != 0x0', async () => {
    let result = await truffleAssert.fails(contractAiakos.checkRelease("superuser", "0x0",{from: accounts[0]}),'revert');
  });
  it('Should execute getReleaseInfo(string)', async () => {
    let result = await contractAiakos.getReleaseInfo("637v05",{from: accounts[0]});
  });
  ...
  it('Should execute isMaintainer(address)', async () => {
    let result = await contractAiakos.isMaintainer(accounts[7],{from: accounts[0]});
  });
  ...
  it('Should execute transferOwnership(address) WHEN _newOwner!=0x0000000000000000000000000000000000000000,msg.sender==_owner', async () => {
    let result = await contractAiakos.methods["transferOwnership(address)"](accounts[3],{from: accounts[0]});
  });
  ...
  it('Should fail transferOwnership(address) when NOT comply with: msg.sender == _owner', async () => {
    let result = await truffleAssert.fails(contractAiakos.methods["transferOwnership(address)"](accounts[3],{from: accounts[9]}),'revert');
  });
});
