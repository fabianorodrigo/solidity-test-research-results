...
contract("Aiakos",(accounts)=>{
  ...
  it('Should execute deployRelease(string,bytes32) WHEN MemberAccess.Identifier!=true', async () => {
    let result = await contractAiakos.deployRelease("Example", [90,39,180,31,114,74,198,183,251,243,154,189,94,84,218,172,114,45,8,104,236,116,245,184,15,163,81,35,177,88,83,27],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN MemberAccess.Identifier==true', async () => {
    let result = await contractAiakos.deployRelease("RevertWithReason", [151,176,143,128,240,5,200,61,7,244,107,8,166,205,216,84,185,144,10,96,213,184,122,112,227,109,233,16,122,223,150,118],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN approvalGranted==true', async () => {
    let result = await contractAiakos.deployRelease("IsLibrary", [152,60,77,180,2,105,208,196,108,233,33,6,74,245,117,255,110,19,251,158,130,211,84,118,188,62,183,161,242,139,43,64],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN approvalGranted!=true', async () => {
    let result = await contractAiakos.deployRelease("bouncer", [195,14,146,224,92,67,63,133,38,65,243,57,250,137,24,216,128,252,160,201,48,42,29,157,205,245,110,93,104,227,42,19],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN releaseApproved==true', async () => {
    let result = await contractAiakos.deployRelease("IsLibrary", [228,245,156,19,188,177,172,65,108,70,126,127,177,167,116,178,29,15,2,205,60,86,101,184,67,181,95,153,99,127,213,186],{from: accounts[0]});
  });
  it('Should execute deployRelease(string,bytes32) WHEN releaseApproved!=true,approvalGranted!=true', async () => {
    let result = await contractAiakos.deployRelease("bouncer", [90,134,132,130,105,158,178,248,0,33,234,164,172,35,45,132,39,250,118,86,52,95,15,199,124,6,106,222,244,162,198,217],{from: accounts[0]});
  });
  it('Should execute checkRelease(string,bytes32) WHEN _sha256Hash!=0x0,MemberAccess.Identifier==true', async () => {
    let result = await contractAiakos.checkRelease("bouncer", [46,1,168,15,75,175,55,52,45,118,59,133,63,33,234,133,105,65,99,152,167,38,48,148,142,137,8,207,93,136,243,89],{from: accounts[0]});
  });
