...
contract("contractProxyDayCountConvention",(accounts)=>{
  ...
  it('Should execute testyearFraction(uint256,uint256,DayCountConvention) WHEN ipdc==Definitions.DayCountConvention.A_AISDA,endTimestamp>=startTimestamp', async () => {
    let result = await contractProxyDayCountConvention.testyearFraction(364, 1461, 0,{from: accounts[0]});
  });
  it('Should fail testyearFraction(uint256,uint256,DayCountConvention) when NOT comply with: endTimestamp >= startTimestamp', async () => {
    let result = await truffleAssert.fails(contractProxyDayCountConvention.testyearFraction(364, 363, 0,{from: accounts[0]}),'revert');
  });
  it('Should execute testyearFraction(uint256,uint256,DayCountConvention) WHEN ipdc==Definitions.DayCountConvention.A_360,endTimestamp>=startTimestamp', async () => {
    let result = await contractProxyDayCountConvention.testyearFraction(31, 146098, 1,{from: accounts[0]});
  });
  it('Should fail testyearFraction(uint256,uint256,DayCountConvention) when NOT comply with: endTimestamp >= startTimestamp', async () => {
    let result = await truffleAssert.fails(contractProxyDayCountConvention.testyearFraction(31, 30, 1,{from: accounts[0]}),'revert');
  });
  it('Should execute testyearFraction(uint256,uint256,DayCountConvention) WHEN ipdc==Definitions.DayCountConvention.A_365,endTimestamp>=startTimestamp', async () => {
    let result = await contractProxyDayCountConvention.testyearFraction(60, 4801, 2,{from: accounts[0]});
  });
  it('Should fail testyearFraction(uint256,uint256,DayCountConvention) when NOT comply with: endTimestamp >= startTimestamp', async () => {
    let result = await truffleAssert.fails(contractProxyDayCountConvention.testyearFraction(60, 59, 2,{from: accounts[0]}),'revert');
  });
  it('Should execute testyearFraction(uint256,uint256,DayCountConvention) WHEN ipdc==Definitions.DayCountConvention._30E_360,endTimestamp>=startTimestamp', async () => {
    let result = await contractProxyDayCountConvention.testyearFraction(3999, 2440587, 4,{from: accounts[0]});
  });
  it('Should fail testyearFraction(uint256,uint256,DayCountConvention) when NOT comply with: endTimestamp >= startTimestamp', async () => {
    let result = await truffleAssert.fails(contractProxyDayCountConvention.testyearFraction(3999, 3998, 4,{from: accounts[0]}),'revert');
  });
  it('Should execute testyearFraction(uint256,uint256,DayCountConvention) WHEN ipdc!=Definitions.DayCountConvention._30E_360,ipdc!=Definitions.DayCountConvention.A_365,ipdc!=Definitions.DayCountConvention.A_360,ipdc!=Definitions.DayCountConvention.A_AISDA,endTimestamp>=startTimestamp', async () => {
    let result = await contractProxyDayCountConvention.testyearFraction(4001, 2440588, 5,{from: accounts[0]});
  });
  it('Should fail testyearFraction(uint256,uint256,DayCountConvention) when NOT comply with: endTimestamp >= startTimestamp', async () => {
    let result = await truffleAssert.fails(contractProxyDayCountConvention.testyearFraction(4001, 4000, 5,{from: accounts[0]}),'revert');
  });
  it('Should execute testactualActualISDA(uint256,uint256)', async () => {
    let result = await contractProxyDayCountConvention.testactualActualISDA(901, 1462,{from: accounts[0]});
  });
  it('Should execute testactualThreeSixty(uint256,uint256)', async () => {
    let result = await contractProxyDayCountConvention.testactualThreeSixty(4900, 86400,{from: accounts[0]});
  });
  it('Should execute testactualThreeSixtyFive(uint256,uint256)', async () => {
    let result = await contractProxyDayCountConvention.testactualThreeSixtyFive(900, 86401,{from: accounts[0]});
  });
  it('Should execute testthirtyEThreeSixty(uint256,uint256)', async () => {
    let result = await contractProxyDayCountConvention.testthirtyEThreeSixty(899, 1532892062,{from: accounts[0]});
  });
});
